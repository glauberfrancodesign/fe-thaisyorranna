...
*/
    ...
    n("Promise", function (a) {
        function b(g) { this.h = 0; this.j = void 0; this.i = []; this.B = !1; var h = this.l(); try { g(h.resolve, h.reject) } catch (k) { h.reject(k) } }
    ...
    ; var eb = Array.prototype.indexOf ? function (a, b) { return Array.prototype.indexOf.call(a, b, void 0) } : function (a, b) {
        ...
        return d
    }, jb = Array.prototype.every ? function (a, b) { return Array.prototype.every.call(a, b, void 0) } : function (a, b) {
    ...
    Hc[" "] = function () { }; var Ic = C("Opera"), Jc = Ub(), Kc = C("Edge"), Lc = C("Gecko") && !(-1 != Tb().toLowerCase().indexOf("webkit") && !C("Edge")) && !(C("Trident") || C("MSIE")) && !C("Edge"), Mc = -1 != Tb().toLowerCase().indexOf("webkit") && !C("Edge"), Nc = C("Android"); function Oc() { var a = z.document; return a ? a.documentMode : void 0 }
    var Pc; a: {
        var Qc = "", Rc = function () { var a = Tb(); if (Lc) return /rv:([^\);]+)(\)|;)/.exec(a); if (Kc) return /Edge\/([\d\.]+)/.exec(a); if (Jc) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a); if (Mc) return /WebKit\/(\S+)/.exec(a); if (Ic) return /(?:Version)[ \/]?(\S+)/.exec(a) }();
        Rc && (Qc = Rc ? Rc[1] : ""); if (Jc) { var Sc = Oc(); if (null != Sc && Sc > parseFloat(Qc)) { Pc = String(Sc); break a } } Pc = Qc
    } var Tc = Pc, Uc; if (z.document && Jc) { var Vc = Oc(); Uc = Vc ? Vc : parseInt(Tc, 10) || void 0 } else Uc = void 0; var Wc = Uc; var Xc = Fc() || C("iPod"), Yc = C("iPad"); $b(); Xb(); var Zc = Wb() && !(Fc() || C("iPad") || C("iPod")); var $c = {}, ad = null; function bd(a, b) { Pa(a); void 0 === b && (b = 0); cd(); b = $c[b]; for (var c = Array(Math.floor(a.length / 3)), d = b[64] || "", e = 0, f = 0; e < a.length - 2; e += 3) { var g = a[e], h = a[e + 1], k = a[e + 2], m = b[g >> 2]; g = b[(g & 3) << 4 | h >> 4]; h = b[(h & 15) << 2 | k >> 6]; k = b[k & 63]; c[f++] = "" + m + g + h + k } m = 0; k = d; switch (a.length - e) { case 2: m = a[e + 1], k = b[(m & 15) << 2] || d; case 1: a = a[e], c[f] = "" + b[a >> 2] + b[(a & 3) << 4 | m >> 4] + k + d }return c.join("") }
    function dd(a) {
        var b = a.length, c = 3 * b / 4; c % 3 ? c = Math.floor(c) : -1 != "=.".indexOf(a[b - 1]) && (c = -1 != "=.".indexOf(a[b - 2]) ? c - 2 : c - 1); var d = new Uint8Array(c), e = 0; ed(a, function (f) { d[e++] = f });
        return e !== c ? d.subarray(0, e) : d
    }
    function ed(a, b) {
        function c(k) { for (; d < a.length;) { var m = a.charAt(d++), q = ad[m]; if (null != q) return q; if (!/^[\s\xa0]*$/.test(m)) throw Error("Unknown base64 encoding at char: " + m); } return k }
    ...
    function kd(a, b) { jd(b); this.ca = a; if (null != a && 0 === a.length) throw Error("ByteString should be constructed with non-empty values"); }
    function ld() { return id || (id = new kd(null, hd)) }
    kd.prototype.Ma = function () { return null == this.ca };
    kd.prototype.sizeBytes = function () { jd(hd); var a = this.ca; null == a || gd(a) || ("string" === typeof a ? a = dd(a) : (Oa(a), a = null)); return (a = null == a ? a : this.ca = a) ? a.length : 0 }; var md = "function" === typeof Symbol && "symbol" === typeof Symbol() ? Symbol(void 0) : void 0; function rd(a, b) { Object.isFrozen(a) || (md ? a[md] |= b : void 0 !== a.ga ? a.ga |= b : Object.defineProperties(a, { ga: { value: b, configurable: !0, writable: !0, enumerable: !1 } })) }
    function sd(a, b) { Object.isExtensible(a) && (md ? a[md] && (a[md] &= ~b) : void 0 !== a.ga && (a.ga &= ~b)) }
    function td(a) { var b; md ? b = a[md] : b = a.ga; return null == b ? 0 : b }
    function ud(a, b) { md ? a[md] = b : void 0 !== a.ga ? a.ga = b : Object.defineProperties(a, { ga: { value: b, configurable: !0, writable: !0, enumerable: !1 } }) }
    function vd(a) { rd(a, 1); return a }
    function wd(a) { rd(a, 17); return a }
    function xd(a) { return a ? !!(td(a) & 2) : !1 }
    function yd(a) { rd(a, 16); return a }
    function zd(a, b) { ud(b, (td(a) | 0) & -51) }
    function Ad(a, b) { ud(b, (td(a) | 18) & -33) }
    ; var Bd = {}; function Cd(a) { return null !== a && "object" === typeof a && !Array.isArray(a) && a.constructor === Object }
    var Dd, Ed = Object, Fd = Ed.freeze, Gd = []; rd(Gd, 3); var Hd = Fd.call(Ed, Gd); function Id(a) { if (xd(a.u)) throw Error("Cannot mutate an immutable Message"); }
    ...
    ; function Ld(a) { switch (typeof a) { case "number": return isFinite(a) ? a : String(a); case "object": if (a && !Array.isArray(a)) { if (gd(a)) return bd(a); if (a instanceof kd) { var b = a.ca; return null == b ? "" : "string" === typeof b ? b : a.ca = bd(b) } } }return a }
    ...
    function Nd(a, b, c, d) { d = d ? !!(td(a) & 16) : void 0; var e = Array.prototype.slice.call(a); c(a, e); for (a = 0; a < e.length; a++)e[a] = Md(e[a], b, c, d); return e }
    function Od(a) { return a.ib === Bd ? a.toJSON() : Ld(a) }
    function Pd(a) { if (!a) return a; if ("object" === typeof a) { if (gd(a)) return new Uint8Array(a); if (a.ib === Bd) return a.clone() } return a }
    function Qd() { }
    ; function Rd(a, b, c) { return -1 === b ? null : b >= a.qa ? a.R ? a.R[b] : void 0 : (void 0 === c ? 0 : c) && a.R && (c = a.R[b], null != c) ? c : a.u[b + a.la] }
    function D(a, b, c, d, e) { d = void 0 === d ? !1 : d; (void 0 === e ? 0 : e) || Id(a); a.j && (a.j = void 0); if (b >= a.qa || d) return (a.R || (a.R = a.u[a.qa + a.la] = {}))[b] = c, a; void 0 !== a.R && a.qa >= a.u.length ? (d = a.u.length - 1, e = b + a.la, e >= d ? (a.u[d] = void 0, a.u[e] = c, a.u.push(a.R)) : a.u[e] = c) : a.u[b + a.la] = c; void 0 !== a.R && b in a.R && delete a.R[b]; return a }
    function Sd(a, b, c, d) { var e = Rd(a, b, d); Array.isArray(e) || (e = Hd); var f = td(e); f & 1 || vd(e); if (xd(a.u)) f & 2 || rd(e, 2), c & 1 || Object.freeze(e); else if (!(c & 1) && f & 2) e = vd(Array.prototype.slice.call(e)), D(a, b, e, d); else if (!(c & 2) && f & 16) { a = e; if (!Array.isArray(a)) throw Error("cannot mark non-array as shared mutably"); sd(a, 16) } return e }
    function Td(a, b, c, d) { Id(a); (c = Ud(a, c)) && c !== b && null != d && D(a, c, void 0, !1); return D(a, b, d) }
    function Ud(a, b) { for (var c = 0, d = 0; d < b.length; d++) { var e = b[d]; null != Rd(a, e) && (0 !== c && D(a, c, void 0, !1, !0), c = e) } return c }
    function Vd(a, b, c, d) { var e = d = void 0 === d ? !1 : d, f = Rd(a, c, e); var g = !1; var h = null == f || "object" !== typeof f || (g = Array.isArray(f)) || f.ib !== Bd ? g ? new b(f) : void 0 : f; h !== f && null != h && (D(a, c, h, e, !0), rd(h.u, td(a.u) & -33)); b = h; if (null == b) return b; xd(b.u) && !xd(a.u) && (b = Wd(b), D(a, c, b, d)); return b }
    function Xd(a, b, c, d, e) {
        e = void 0 === e ? !0 : e; a.h || (a.h = {}); var f = a.h[c], g = Sd(a, c, 3, d), h = xd(a.u); if (f) h || (Object.isFrozen(f) ? e || (f = Array.prototype.slice.call(f), a.h[c] = f) : e && Object.freeze(f)); else {
            f = []; var k = !!(td(a.u) & 16), m = xd(g); !h && m && (g = vd(Array.prototype.slice.call(g)), D(a, c, g, d)); d = m; for (var q = 0; q < g.length; q++) { var r = g[q]; d = d || xd(r); var w = b, t = k, y = !1; y = void 0 === y ? !1 : y; t = void 0 === t ? !1 : t; r = Array.isArray(r) ? new w(t ? yd(r) : r) : y ? new w : void 0; void 0 !== r && (f.push(r), m && rd(r.u, 2)) } a.h[c] = f; a = g; b = !d; Object.isFrozen(a) ||
                (c = td(a) | 33, ud(a, b ? c | 8 : c & -9)); (h || e && m) && rd(f, 2); (h || e) && Object.freeze(f)
        } return f
    }
    function Yd(a, b, c, d) { d = void 0 === d ? !1 : d; var e = xd(a.u); b = Xd(a, b, c, d, e); a = Sd(a, c, 3, d); if (e = !e && a) { if (!a) throw Error("cannot check mutability state of non-array"); e = !(td(a) & 8) } if (e) { for (e = 0; e < b.length; e++)(c = b[e]) && xd(c.u) && (c = e, d = Wd(b[e]), b[c] = d, a[e] = b[e].u); rd(a, 8) } return b }
    function G(a, b, c, d) { Id(a); null != d ? Kd(d, b) : d = void 0; return D(a, c, d) }
    function Zd(a, b, c, d, e) { Id(a); null != e ? Kd(e, b) : e = void 0; Td(a, c, d, e) }
    function $d(a, b, c, d, e) { Id(a); if (null != d) { var f = vd([]); for (var g = !1, h = 0; h < d.length; h++)f[h] = Kd(d[h], b).u, g = g || xd(f[h]); a.h || (a.h = {}); a.h[c] = d; b = f; g ? sd(b, 8) : rd(b, 8) } else a.h && (a.h[c] = void 0), f = Hd; return D(a, c, f, e) }
    function ae(a, b, c, d) { Id(a); var e = Xd(a, c, b, void 0, !1); c = null != d ? Kd(d, c) : new c; a = Sd(a, b, 2); e.push(c); a.push(c.u); xd(c.u) && sd(a, 8) }
    function be(a, b) { return Rd(a, b) }
    function ce(a, b) { return null == a ? b : a }
    ; function de(a, b) { if (null != a) { if (fd && a instanceof Uint8Array) return a.length ? new kd(new Uint8Array(a), hd) : ld(); if (Array.isArray(a)) { if (xd(a)) return a; b && (b = td(a), b = !(b & 32) && (!!(b & 16) || 0 === b)); if (b) return rd(a, 2), a; a = Nd(a, de, Ad); td(a) & 4 && Object.freeze(a); return a } return a.ib === Bd ? ee(a) : a } }
    function fe(a, b, c, d, e, f) { (a = a.h && a.h[c]) ? (d = 0 < a.length ? a[0].constructor : void 0, xd(a) && Object.isFrozen(a) || (f = hb(a, ee), Ad(a, f), Object.freeze(f), a = f), $d(b, d, c, a, e)) : D(b, c, de(d, f), e) }
    function ee(a) { if (xd(a.u)) return a; a = ge(a); rd(a.u, 2); return a }
    function ge(a) { var b = new a.constructor; a.La && (b.La = a.La.slice()); for (var c = a.u, d = !!(td(c) & 16), e = 0; e < c.length; e++) { var f = c[e]; if (e === c.length - 1 && Cd(f)) for (var g in f) { var h = +g; Number.isNaN(h) ? (b.R || (b.R = b.u[b.qa + b.la] = {}))[h] = f[h] : fe(a, b, h, f[g], !0, d) } else fe(a, b, e - a.la, f, !1, d) } return b }
    function Wd(a) { if (!xd(a.u)) return a; var b = ge(a); b.j = a; return b }
    ; function I(a, b, c) {
        null == a && (a = he); he = null; var d = this.constructor.h || 0, e = 0 < d, f = this.constructor.i, g = !1; if (null == a) { var h = f ? [f] : []; rd(h, 48); a = h; h = !0 } else { if (!Array.isArray(a)) throw Error(); if (f && f !== a[0]) throw Error(); if (h = !!(td(a) & 16)) g = td(a), ud(a, g | 32), g = !!(g & 32) } e && 0 < a.length && Cd(a[a.length - 1]) && "g" in a[a.length - 1] && (d = 0); this.la = (f ? 0 : -1) - d; this.h = void 0; this.u = a; a: {
            f = this.u.length; d = f - 1; if (f && (f = this.u[d], Cd(f))) {
                this.R = f; b = Object.keys(f); 0 < b.length && jb(b, isNaN) ? this.qa = Number.MAX_VALUE : this.qa =
                    d - this.la; break a
            } void 0 !== b && -1 < b ? (this.qa = Math.max(b, d + 1 - this.la), this.R = void 0) : this.qa = Number.MAX_VALUE
        } if (!e && this.R && "g" in this.R) throw Error('Unexpected "g" flag in sparse object of message that is not a group type.'); if (c) for (e = h && !g ? wd : vd, b = 0; b < c.length; b++)h = c[b], (g = Rd(this, h)) ? Array.isArray(g) && e(g) : D(this, h, Hd, !1, !0)
    }
    I.prototype.toJSON = function () { var a = this.u, b; Dd ? b = a : b = Nd(a, Od, Qd); return b };
    function ie(a) { Dd = !0; try { return JSON.stringify(a.toJSON(), je) } finally { Dd = !1 } }
    I.prototype.clone = function () { var a = Nd(this.u, Pd, zd); yd(a); he = a; a = new this.constructor(a); he = null; ke(a, this); return a };
    I.prototype.ib = Bd; I.prototype.toString = function () { return this.u.toString() };
    function je(a, b) { return Ld(b) }
    function ke(a, b) { b.La && (a.La = b.La.slice()); var c = b.h; if (c) { b = b.R; for (var d in c) { var e = c[d]; if (e) { var f = !(!b || !b[d]), g = +d; if (Array.isArray(e)) { if (e.length) for (f = Yd(a, e[0].constructor, g, f), g = 0; g < Math.min(f.length, e.length); g++)ke(f[g], e[g]) } else throw Error("unexpected object: type: " + Oa(e) + ": " + e); } } } }
    var he; function le(a) { var b = this.h, c = this.i; return this.isRepeated ? Yd(a, b, c, !0) : Vd(a, b, c, !0) }
    ; function me(a) { this.Tb = a }
    ; function ne(a, b, c) { this.i = a; this.l = b; this.h = c || []; this.Ba = new Map }
    l = ne.prototype; l.Gc = function (a) { var b = Ja.apply(1, arguments), c = this.ub(b); c ? c.push(new me(a)) : this.tc(a, b) };
    l.tc = function (a) { this.Ba.set(this.ac(Ja.apply(1, arguments)), [new me(a)]) };
    ...
    u(oe, ne); oe.prototype.j = function (a) { var b = Ja.apply(1, arguments), c = 0, d = this.Tc(b); d && (c = d.Tb); this.tc(c + a, b) }; function pe(a, b) { ne.call(this, a, 2, b) }
    u(pe, ne); pe.prototype.j = function (a) { this.Gc(a, Ja.apply(1, arguments)) }; function qe(a) { a && "function" == typeof a.dispose && a.dispose() }
    ...
    ue.prototype.preventDefault = function () { this.defaultPrevented = !0 }; function ve(a) {
        var b = B("window.location.href"); null == a && (a = 'Unknown Error of type "null/undefined"'); if ("string" === typeof a) return { message: a, name: "Unknown error", lineNumber: "Not available", fileName: b, stack: "Not available" }; var c = !1; try { var d = a.lineNumber || a.line || "Not available" } catch (g) { d = "Not available", c = !0 } try { var e = a.fileName || a.filename || a.sourceURL || z.$googDebugFname || b } catch (g) { e = "Not available", c = !0 } b = we(a); if (!(!c && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
            c = a.message; if (null ==
    ...
    function we(a, b) { b || (b = {}); b[De(a)] = !0; var c = a.stack || ""; (a = a.cause) && !b[De(a)] && (c += "\nCaused by: ", a.stack && 0 == a.stack.indexOf(a.toString()) || (c += "string" === typeof a ? a : a.message + "\n"), c += we(a, b)); return c }
    function De(a) { var b = ""; "function" === typeof a.toString && (b = "" + a); return b + a.stack }
    var Ce = {}; var Ee = function () {
    ...
    }(); function Fe(a, b) { ue.call(this, a ? a.type : ""); this.relatedTarget = this.h = this.target = null; this.button = this.screenY = this.screenX = this.clientY = this.clientX = 0; this.key = ""; this.charCode = this.keyCode = 0; this.metaKey = this.shiftKey = this.altKey = this.ctrlKey = !1; this.state = null; this.pointerId = 0; this.pointerType = ""; this.i = null; a && this.init(a, b) }
    Za(Fe, ue); var Ge = { 2: "touch", 3: "pen", 4: "mouse" };
    Fe.prototype.init = function (a, b) {
        var c = this.type = a.type, d = a.changedTouches && a.changedTouches.length ? a.changedTouches[0] : null; this.target = a.target || a.srcElement; this.h = b; if (b = a.relatedTarget) { if (Lc) { a: { try { Hc(b.nodeName); var e = !0; break a } catch (f) { } e = !1 } e || (b = null) } } else "mouseover" == c ? b = a.fromElement : "mouseout" == c && (b = a.toElement); this.relatedTarget = b; d ? (this.clientX = void 0 !== d.clientX ? d.clientX : d.pageX, this.clientY = void 0 !== d.clientY ? d.clientY : d.pageY, this.screenX = d.screenX || 0, this.screenY = d.screenY ||
    ...
    var af = "__closure_events_fn_" + (1E9 * Math.random() >>> 0); function Te(a) {
        if ("function" === typeof a) return a; a[af] || (a[af] = function (b) { return a.handleEvent(b) });
        return a[af]
    }
    ; function bf() { J.call(this); this.l = new Le(this); this.Dc = this; this.ka = null }
    ...
    ; var nf; function of() {
        var a = z.MessageChannel; "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && !C("Presto") && (a = function () {
            var e = lf("IFRAME"); e.style.display = "none"; document.documentElement.appendChild(e); var f = e.contentWindow; e = f.document; e.open(); e.close(); var g = "callImmediate" + Math.random(), h = "file:" == f.location.protocol ? "*" : f.location.protocol + "//" + f.location.host; e = Xa(function (k) { if (("*" == h || k.origin == h) && k.data == g) this.port1.onmessage() }, this);
            f.addEventListener("message", e, !1); this.port1 = {}; this.port2 = { postMessage: function () { f.postMessage(g, h) } }
        });
        if ("undefined" !== typeof a && !Ub()) {
            var b = new a, c = {}, d = c; b.port1.onmessage = function () { if (void 0 !== c.next) { c = c.next; var e = c.Sb; c.Sb = null; e() } };
            return function (e) { d.next = { Sb: e }; d = d.next; b.port2.postMessage(0) }
    ...
    function wf() {
        if (z.Promise && z.Promise.resolve) { var a = z.Promise.resolve(void 0); sf = function () { a.then(xf) } } else sf = function () {
            var b = xf;
    ...
    yf.prototype.$goog_Thenable = !0; l = yf.prototype; l.ob = function (a, b) { return Ef(this, null, a, b) };
    l.catch = yf.prototype.ob; l.cancel = function (a) { if (0 == this.h) { var b = new Ff(a); vf(function () { Gf(this, b) }, this) } };
    ...
    function Ef(a, b, c, d) {
        var e = Cf(null, null, null); e.h = new yf(function (f, g) {
    ...
    l.Cd = function (a) { this.h = 0; zf(this, 2, a) };
    l.Dd = function (a) { this.h = 0; zf(this, 3, a) };
    ...
    function Kf(a) { a.o || (a.o = !0, vf(a.Rc, a)) }
    function Hf(a) { var b = null; a.i && (b = a.i, a.i = b.next, b.next = null); a.i || (a.l = null); return b }
    l.Rc = function () { for (var a; a = Hf(this);)If(this, a, this.h, this.B); this.o = !1 };
    ...
    Za(Ff, ab); Ff.prototype.name = "cancel"; function Pf(a, b) { bf.call(this); this.j = a || 1; this.i = b || z; this.m = Xa(this.Ad, this); this.o = Date.now() }
    Za(Pf, bf); l = Pf.prototype; l.enabled = !1; l.ba = null; function Qf(a, b) { a.j = b; a.ba && a.enabled ? (a.stop(), a.start()) : a.ba && a.stop() }
    l.Ad = function () { if (this.enabled) { var a = Date.now() - this.o; 0 < a && a < .8 * this.j ? this.ba = this.i.setTimeout(this.m, this.j - a) : (this.ba && (this.i.clearTimeout(this.ba), this.ba = null), cf(this, "tick"), this.enabled && (this.stop(), this.start())) } };
    ...
    l = Sf.prototype; l.qc = function (a) { this.m = a; this.l = 1 };
    function Tf(a) { a.i.enabled || a.i.start(); a.j++; a.j >= a.l && a.qb() }
    l.qb = function () {
        var a = this.h.values(); a = [].concat(ia(a)).filter(function (b) { return b.Ba.size });
        a.length && this.B.flush(a, this.m); Uf(a); this.j = 0; this.i.enabled && this.i.stop()
    };
    l.Hc = function (a) { var b = Ja.apply(1, arguments); this.h.has(a) || this.h.set(a, new oe(a, b)) };
    l.Qb = function (a) { var b = Ja.apply(1, arguments); this.h.has(a) || this.h.set(a, new pe(a, b)) };
    function Vf(a, b) { return a.o.has(b) ? void 0 : a.h.get(b) }
    l.Lb = function (a) { this.Bc.apply(this, [a, 1].concat(ia(Ja.apply(1, arguments)))) };
    l.Bc = function (a, b) { var c = Ja.apply(2, arguments), d = Vf(this, a); d && d instanceof oe && (d.j(b, c), Tf(this)) };
    ...
    ; function Wf(a) { this.h = a; this.h.Qb("/client_streamz/bg/fil", { tb: 3, sb: "rk" }) }
    function Xf(a) { this.h = a; this.h.Hc("/client_streamz/bg/fsc", { tb: 3, sb: "rk" }) }
    function Yf(a) { this.h = a; this.h.Qb("/client_streamz/bg/fsl", { tb: 3, sb: "rk" }) }
    ...
    function lg(a, b, c) {
        var d = [], e = []; if (1 == (Array.isArray(c) ? 2 : 1)) return e = [b, a], fb(d, function (h) { e.push(h) }), mg(e.join(" "));
    ...
    l.set = function (a, b, c) {
        var d = !1; if ("object" === typeof c) { var e = c.Dr; d = c.secure || !1; var f = c.domain || void 0; var g = c.path || void 0; var h = c.hb } if (/[;=\s]/.test(a)) throw Error('Invalid cookie name "' + a + '"'); if (/[;\r\n]/.test(b)) throw Error('Invalid cookie value "' + b + '"'); void 0 === h && (h = -1); c = f ? ";domain=" + f : ""; g = g ? ";path=" + g : ""; d = d ? ";secure" : ""; h = 0 > h ? "" : 0 == h ? ";expires=" + (new Date(1970, 1, 1)).toUTCString() : ";expires=" + (new Date(Date.now() + 1E3 * h)).toUTCString(); this.h.cookie = a + "=" + b + c + g + h + d + (null != e ? ";samesite=" +
            e : "")
    };
    ...
    function zg(a, b, c) {
        if (null == b) c.push("null"); else {
            if ("object" == typeof b) { if (Array.isArray(b)) { var d = b; b = d.length; c.push("["); for (var e = "", f = 0; f < b; f++)c.push(e), zg(a, d[f], c), e = ","; c.push("]"); return } if (b instanceof String || b instanceof Number || b instanceof Boolean) b = b.valueOf(); else { c.push("{"); e = ""; for (d in b) Object.prototype.hasOwnProperty.call(b, d) && (f = b[d], "function" != typeof f && (c.push(e), Bg(d, c), c.push(":"), zg(a, f, c), e = ",")); c.push("}"); return } } switch (typeof b) {
                case "string": Bg(b, c); break; case "number": c.push(isFinite(b) &&
    ...
    Gg = new Hg; function Lg(a) { bf.call(this); this.headers = new Map; this.K = a || null; this.i = !1; this.I = this.v = null; this.m = this.S = ""; this.j = this.P = this.s = this.O = !1; this.o = 0; this.F = null; this.da = ""; this.W = this.X = !1 }
    Za(Lg, bf); var Mg = /^https?$/i, Ng = ["POST", "PUT"], Og = []; function Pg(a, b, c, d, e, f, g) { var h = new Lg; Og.push(h); b && h.ia("complete", b); h.l.add("ready", h.Mc, !0, void 0, void 0); f && (h.o = Math.max(0, f)); g && (h.X = g); h.send(a, c, d, e) }
    l = Lg.prototype; l.Mc = function () { this.dispose(); mb(Og, this) };
    l.send = function (a, b, c, d) {
        if (this.v) throw Error("[goog.net.XhrIo] Object is active with another request=" + this.S + "; newUri=" + a); b = b ? b.toUpperCase() : "GET"; this.S = a; this.m = ""; this.O = !1; this.i = !0; this.v = this.K ? Kg(this.K) : Kg(Gg); this.I = this.K ? this.K.getOptions() : Gg.getOptions(); this.v.onreadystatechange = Xa(this.jc, this); try { this.getStatus(), this.P = !0, this.v.open(b, String(a), !0), this.P = !1 } catch (g) { this.getStatus(); Qg(this, g); return } a = c || ""; c = new Map(this.headers); if (d) if (Object.getPrototypeOf(d) === Object.prototype) for (var e in d) c.set(e,
        ...
        e = z.FormData && a instanceof z.FormData; !(0 <= eb(Ng, b)) || d || e || c.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8"); b = p(c); for (d = b.next(); !d.done; d = b.next())c = p(d.value), d = c.next().value, c = c.next().value, this.v.setRequestHeader(d, c); this.da && (this.v.responseType = this.da); "withCredentials" in this.v && this.v.withCredentials !== this.X && (this.v.withCredentials = this.X); try {
        ...
        } catch (g) { this.getStatus(), Qg(this, g) }
    };
    function Sg(a) { return Jc && "number" === typeof a.timeout && void 0 !== a.ontimeout }
    l.wc = function () { "undefined" != typeof Ma && this.v && (this.m = "Timed out after " + this.o + "ms, aborting", this.getStatus(), cf(this, "timeout"), this.abort(8)) };
    ...
    l.jc = function () { this.h() || (this.P || this.s || this.j ? Vg(this) : this.ed()) };
    l.ed = function () { Vg(this) };
    function Vg(a) { if (a.i && "undefined" != typeof Ma) if (a.I[1] && 4 == Wg(a) && 2 == a.getStatus()) a.getStatus(); else if (a.s && 4 == Wg(a)) Rf(a.jc, 0, a); else if (cf(a, "readystatechange"), a.isComplete()) { a.getStatus(); a.i = !1; try { if (Xg(a)) cf(a, "complete"), cf(a, "success"); else { try { var b = 2 < Wg(a) ? a.v.statusText : "" } catch (c) { b = "" } a.m = b + " [" + a.getStatus() + "]"; Tg(a) } } finally { Ug(a) } } }
    function Ug(a, b) {
        if (a.v) {
            Rg(a); var c = a.v, d = a.I[0] ? function () { } : null;
    ...
    u(ih, I); var jh; jh = new function (a, b, c) { this.i = a; this.fieldName = b; this.h = c; this.isRepeated = 0; this.j = le }(175237375, { tr: 0 }, ih); function kh(a, b, c, d, e, f, g, h, k, m, q) {
        bf.call(this); var r = this; this.O = ""; this.j = []; this.Ob = ""; this.Pb = this.va = -1; this.Xa = !1; this.I = this.m = null; this.F = 0; this.Ec = 1; this.timeoutMillis = 0; this.da = !1; bf.call(this); this.Ya = b || function () { };
        this.s = new lh(a, f); this.Cc = d; this.Wa = q; this.Fc = Ya(gf, 0, 1); this.S = e || null; this.K = c || null; this.W = g || !1; this.pageId = k || null; this.logger = null; this.withCredentials = !h; this.Ia = f || !1; !this.Ia && (65 <= cc("Chromium") || 45 <= cc("Firefox") || 12 <= cc("Safari") || (Fc() || C("iPad") || C("iPod")) && Gc()); a = D(new bh, 1, 1); mh(this.s, a); this.o = new xg(1E4); this.i = new Pf(this.o.getValue()); se(this, this.i); m = nh(this, m); Re(this.i, "tick", m, !1, this); this.P = new Pf(6E5); se(this, this.P); Re(this.P, "tick", m, !1, this); this.W || this.P.start();
    ...
    function oh(a) { a.S || (a.S = .01 > a.Fc() ? "https://www.google.com/log?format=json&hasfast=true" : "https://play.google.com/log?format=json&hasfast=true"); return a.S }
    ...
    kh.prototype.flush = function (a, b) {
        var c = this; if (0 === this.j.length) a && a(); else if (this.da) rh(this); else {
            var d = Date.now(); if (this.Pb > d && this.va < d) b && b("throttled"); else {
                var e = sh(this.s, this.j, this.F); d = {}; var f = this.Ya(); f && (d.Authorization = f); var g = oh(this); this.K && (d["X-Goog-AuthUser"] = this.K, g = zc(g, "authuser", this.K)); this.pageId && (d["X-Goog-PageId"] = this.pageId, g = zc(g, "pageId", this.pageId)); if (f && this.Ob === f) b && b("stale-auth-token"); else {
                    this.j = []; this.i.enabled && this.i.stop(); this.F = 0; var h = ie(e),
                        k; this.I && this.I.isSupported(h.length) && (k = this.I.compress(h)); var m = { url: g, body: h, Kc: 1, Gb: d, requestType: "POST", withCredentials: this.withCredentials, timeoutMillis: this.timeoutMillis }, q = function (t) { c.o.reset(); Qf(c.i, c.o.getValue()); if (t) { var y = null; try { var E = JSON.parse(t.replace(")]}'\n", "")); y = new gh(E) } catch (F) { } y && (t = Number(ce(Rd(y, 1), "-1")), 0 < t && (c.va = Date.now(), c.Pb = c.va + t), y = jh.j(y)) && (y = ce(Rd(y, 1), -1), -1 != y && (c.Xa || ph(c, y))) } a && a() }, r = function (t, y) {
                            var E = Yd(e, ch, 3), F = c.o;
                            F.h = Math.min(3E5, 2 * F.h); F.i = Math.min(3E5, F.h + Math.round(.2 * (Math.random() - .5) * F.h)); Qf(c.i, c.o.getValue()); 401 === t && f && (c.Ob = f); void 0 === y && (y = 500 <= t && 600 > t || 401 === t || 0 === t); y && (c.j = E.concat(c.j), c.W || c.i.enabled || c.i.start()); b && b("net-send-failed", t)
                        }, w = function () { c.Wa ? c.Wa.send(m, q, r) : c.Cc(m, q, r) };
    ...
    function rh(a) { th(a, function (b, c) { b = zc(b, "format", "json"); b = window.navigator.sendBeacon(b, ie(c)); a.da && !b && (a.da = !1); return b }) }
    ...
    function mh(a, b) { G(a.h, bh, 1, b); Rd(b, 1) || D(b, 1, 1); a.i || (b = uh(a), Rd(b, 5) || D(b, 5, a.locale)); a.uach && (b = uh(a), Vd(b, Zg, 9) || G(b, Zg, 9, a.uach)) }
    ...
    function uh(a) { a = Vd(a.h, bh, 1); var b = Vd(a, Yg, 11); b || (b = new Yg, G(a, Yg, 11, b)); return b }
    function sh(a, b, c) { c = void 0 === c ? 0 : c; a = a.h.clone(); var d = Date.now().toString(); a = D(a, 4, d); b = $d(a, ch, 3, b); c && D(b, 14, c); return b }
    ; function wh(a, b, c) { Pg(a.url, function (d) { d = d.target; if (Xg(d)) { try { var e = d.v ? d.v.responseText : "" } catch (f) { e = "" } b(e) } else c(d.getStatus()) }, a.requestType, a.body, a.Gb, a.timeoutMillis, a.withCredentials) }
    ; function xh() { this.j = "https://play.google.com/log?format=json&hasfast=true"; this.s = !1; this.m = wh; this.h = "" }
    ; function yh() { var a = void 0 === a ? "" : a; var b = void 0 === b ? "" : b; var c = new xh; c.h = ""; "" != a && (c.j = a); b && (c.i = b); a = new kh(1828, c.I ? c.I : ug, "0", c.m, c.j, c.s, !1, c.P, void 0, void 0, c.o ? c.o : void 0); c.M && mh(a.s, c.M); if (c.i) { b = c.i; var d = uh(a.s); D(d, 7, b) } c.l && (a.I = c.l); c.h && (a.O = c.h); c.B && ((b = c.B) ? (a.m || (a.m = new vg), b = ie(b), D(a.m, 4, b)) : a.m && D(a.m, 4, void 0, !1)); c.K && (d = c.K, a.m || (a.m = new vg), b = a.m, null == d ? d = Hd : vd(d), D(b, 2, d)); c.F && (b = c.F, a.Xa = !0, ph(a, b)); c.O && vh(a.s, c.O); this.h = a }
    yh.prototype.flush = function (a) {
        var b = a || []; if (b.length) {
            a = new gg; for (var c = [], d = 0; d < b.length; d++) {
                var e = b[d], f = e, g = new Zf; var h = D(g, 1, f.i); var k = f; g = []; for (var m = 0; m < k.h.length; m++)g.push(k.h[m].sb); if (null == g) g = Hd; else { for (k = 0; k < g.length; k++); rd(g, 5) } g = D(h, 3, g); h = []; k = []; m = p(f.Ba.keys()); for (var q = m.next(); !q.done; q = m.next())k.push(q.value.split(",")); for (m = 0; m < k.length; m++) {
                    q = k[m]; var r = f.l; for (var w = f.ub(q) || [], t = [], y = 0; y < w.length; y++) {
                        var E = w[y]; E = E && E.Tb; var F = new dg; switch (r) {
                            case 3: Td(F, 1,
                                fg, Number(E)); break; case 2: Td(F, 2, fg, Number(E))
                        }t.push(F)
                    } r = t; for (w = 0; w < r.length; w++) { t = r[w]; y = new ag; t = G(y, dg, 2, t); y = q; E = []; F = f; for (var O = [], N = 0; N < F.h.length; N++)O.push(F.h[N].tb); F = O; for (O = 0; O < F.length; O++) { N = F[O]; var Q = y[O], ca = new cg; switch (N) { case 3: Td(ca, 1, eg, String(Q)); break; case 2: Td(ca, 2, eg, Number(Q)); break; case 1: Td(ca, 3, eg, "true" == Q) }E.push(ca) } $d(t, cg, 1, E); h.push(t) }
                } $d(g, ag, 4, h); c.push(g); e.clear()
            } $d(a, Zf, 1, c); b = this.h; a instanceof ch ? b.log(a) : (c = new ch, a = ie(a), a = D(c, 8, a), b.log(a)); this.h.flush()
        }
    }; function zh(a) { this.Ea = a; this.o = Ah(); this.l = new yh; this.h = new Sf(this.l); this.m = new Wf(this.h); this.i = new Xf(this.h); this.j = new Yf(this.h) }
    ...
    ; function Ch(a) {
        var b = this; this.i = !1; var c = a.program; var d = a.Vc; if (a.jd) { var e; this.wa = null != (e = a.wa) ? e : new zh(d) } var f = new Bh; this.j = f.promise; this.l = p((0, z[d].a)(c, function (g, h) { Promise.resolve().then(function () { var k; if (null != (k = b.wa)) { var m = Ah() - k.o; k.m.h.pb("/client_streamz/bg/fil", m, k.Ea) } f.resolve({ Ic: g, wd: h }) }) }, !0)).next().value;
        this.vd = f.promise.then(function () { })
    }
    Ch.prototype.snapshot = function (a) {
        var b = this; if (this.i) throw Error("Already disposed"); var c = Ah(), d; null != (d = this.wa) && d.i.h.Lb("/client_streamz/bg/fsc", d.Ea); return this.j.then(function (e) {
            var f = e.Ic; return new Promise(function (g) {
                f(function (h) { var k; if (null != (k = b.wa)) { var m = Ah() - c; k.j.h.pb("/client_streamz/bg/fsl", m, k.Ea) } g(h) }, [a.Vb,
                a.xd])
            })
        })
    };
    Ch.prototype.uc = function (a) { if (this.i) throw Error("Already disposed"); var b = Ah(), c; null != (c = this.wa) && c.i.h.Lb("/client_streamz/bg/fsc", c.Ea); a = this.l([a.Vb, a.xd]); null != (c = this.wa) && (b = Ah() - b, c.j.h.pb("/client_streamz/bg/fsl", b, c.Ea)); return a };
    Ch.prototype.dispose = function () { var a; null != (a = this.wa) && a.h.qb(); this.i = !0; this.j.then(function (b) { (b = b.wd) && b() }) };
...
*/
    ...
    function Jh() {
        var a = []; Hh(function (b) { a.push(b) });
        return a
    }
    var Ih = { Rd: "allow-forms", Sd: "allow-modals", Td: "allow-orientation-lock", Ud: "allow-pointer-lock", Vd: "allow-popups", Wd: "allow-popups-to-escape-sandbox", Xd: "allow-presentation", Yd: "allow-same-origin", Zd: "allow-scripts", ae: "allow-top-navigation", be: "allow-top-navigation-by-user-activation" }, Kh = db(function () { return Jh() });
    function Lh() {
        var a = Mh(), b = {}; fb(Kh(), function (c) { a.sandbox && a.sandbox.supports && a.sandbox.supports(c) && (b[c] = !0) });
        return b
    }
    function Mh() { var a = void 0 === a ? document : a; return a.createElement("iframe") }
    ; function Nh(a) { this.bd = a }
    ...
    ; var Rh = (new Date).getTime(); var Sh = "client_dev_domain client_dev_regex_map client_dev_root_url client_rollout_override expflag forcedCapability jsfeat jsmode mods".split(" "); ia(Sh); function Th(a) {
        bf.call(this); var b = this; this.s = this.j = 0; this.Z = null != a ? a : {
            U: function (e, f) { return setTimeout(e, f) },
    ...
    function Uh(a, b) {
        return a.o ? a.o : a.o = new Promise(function (c) {
            var d, e, f, g; return x(function (h) {
                switch (h.h) {
                    case 1: return d = window.AbortController ? new window.AbortController : void 0, f = null == (e = d) ? void 0 : e.signal, g = !1, ya(h, 2, 3), d && (a.j = a.Z.U(function () { d.abort() }, b || 2E4)), v(h, fetch("/generate_204", {
                        method: "HEAD",
                        signal: f
                    }), 5); case 5: g = !0; case 3: Ba(h); a.o = void 0; a.j && (a.Z.fa(a.j), a.j = 0); g !== a.i && (a.i = g, a.i ? cf(a, "networkstatus-online") : cf(a, "networkstatus-offline")); c(g); Ca(h); break; case 2: Aa(h), g = !1, h.A(3)
                }
            })
        })
    }
    ...
    ii.prototype.ea = function () { return this }; function li(a) {
        if (a instanceof mi || a instanceof ni || a instanceof oi) return a; if ("function" == typeof a.next) return new mi(function () { return a });
    ...
    function oi(a) {
        mi.call(this, function () { return a });
        this.j = a
    }
    ...
    l = pi.prototype; l.xb = function () { qi(this); return this.h.concat() };
    ...
    l.ea = function (a) {
        qi(this); var b = 0, c = this.ra, d = this, e = new ii; e.next = function () { if (c != d.ra) throw Error("The map has changed since the iterator was created"); if (b >= d.h.length) return ji; var f = d.h[b++]; return ki(a ? f : d.i[f]) };
        return e
    };
    ...
    l.ea = function (a) {
        var b = 0, c = this.h, d = new ii; d.next = function () { if (b >= c.length) return ji; var e = c.key(b++); if (a) return ki(e); e = c.getItem(e); if ("string" !== typeof e) throw "Storage mechanism: Invalid value was encountered"; return ki(e) };
        return d
    };
    ...
    l.ea = function (a) {
        var b = 0, c = this.h.XMLDocument.documentElement.attributes, d = new ii; d.next = function () { if (b >= c.length) return ji; var e = c[b++]; if (a) return ki(decodeURIComponent(e.nodeName.replace(/\./g, "%")).slice(1)); e = e.nodeValue; if ("string" !== typeof e) throw "Storage mechanism: Invalid value was encountered"; return ki(e) };
        return d
    };
    ...
    Ji.prototype.ea = function (a) {
        var b = this.i[Symbol.iterator](), c = this, d = new ii; d.next = function () { var e = b.next(); if (e.done) return e; for (e = e.value; e.slice(0, c.h.length) != c.h;) { e = b.next(); if (e.done) return e; e = e.value } return ki(a ? e.slice(c.h.length) : c.i.get(e)) };
        return d
    }; function Ki(a) { I.call(this, a) }
    u(Ki, I); function Li(a) { I.call(this, a) }
    u(Li, I); Li.prototype.getKey = function () { return Rd(this, 1) };
    Li.prototype.getValue = function () { return be(this, 2 === Ud(this, Mi) ? 2 : -1) };
    ...
    u(Ri, I); Ri.prototype.getPlayerType = function () { return Rd(this, 36) };
    ...
    ; var aj = new $i("continuationCommand"); var bj = new $i("webCommandMetadata"); var cj = new $i("signalServiceEndpoint"); var dj = { si: "EMBEDDED_PLAYER_MODE_UNKNOWN", ni: "EMBEDDED_PLAYER_MODE_DEFAULT", ri: "EMBEDDED_PLAYER_MODE_PFP", oi: "EMBEDDED_PLAYER_MODE_PFL" }; var ej = new $i("feedbackEndpoint"); var fj = { Mq: "WEB_DISPLAY_MODE_UNKNOWN", Iq: "WEB_DISPLAY_MODE_BROWSER", Kq: "WEB_DISPLAY_MODE_MINIMAL_UI", Lq: "WEB_DISPLAY_MODE_STANDALONE", Jq: "WEB_DISPLAY_MODE_FULLSCREEN" }; function gj(a) { I.call(this, a, -1, hj) }
    u(gj, I); function ij(a) { I.call(this, a) }
    u(ij, I); ij.prototype.getKey = function () { return ce(Rd(this, 1), "") };
    ij.prototype.getValue = function () { return ce(Rd(this, 2), "") };
    var hj = [4, 5]; function jj(a) { I.call(this, a) }
    u(jj, I); function kj(a) { I.call(this, a) }
    u(kj, I); var lj = [2, 3, 4]; function mj(a) { I.call(this, a) }
    u(mj, I); mj.prototype.getMessage = function () { return ce(Rd(this, 1), "") }; function nj(a) { I.call(this, a) }
    ...
    u(Ij, I); Ij.prototype.getPlayerType = function () { var a = Rd(this, 7); return null == a ? 0 : a };
    Ij.prototype.setVideoId = function (a) { return D(this, 19, a) };
    function Kj(a, b) { ae(a, 68, Lj, b) }
    function Lj(a) { I.call(this, a) }
    u(Lj, I); Lj.prototype.getId = function () { return ce(Rd(this, 2), "") };
    ...
    var kk = [23, 24, 11, 6, 7, 5, 2, 3, 13, 20, 21, 22, 28, 32, 37, 229, 241, 45, 59, 225, 288, 72, 73, 78, 208, 156, 202, 215, 74, 76, 79, 80, 111, 85, 91, 97, 100, 102, 105, 119, 126, 127, 136, 146, 148, 151, 157, 158, 159, 163, 164, 168, 444, 176, 222, 383, 177, 178, 179, 411, 184, 188, 189, 190, 191, 193, 194, 195, 196, 197, 198, 199, 200, 201, 402, 320, 203, 204, 205, 206, 258, 259, 260, 261, 327, 209, 219, 226, 227, 232, 233, 234, 240, 244, 247, 248, 249, 251, 256, 257, 266, 254, 255, 270, 272, 278, 291, 293, 300, 304, 308, 309, 310, 311, 313, 314, 319, 321, 323, 324, 328, 330, 331, 332, 334, 337, 338, 340, 344, 348, 350, 351,
        352, 353, 354, 355, 356, 357, 358, 361, 363, 364, 368, 369, 370, 373, 374, 375, 378, 380, 381, 388, 389, 403, 410, 412, 429, 413, 414, 415, 416, 417, 418, 430, 423, 424, 425, 426, 427, 431, 117, 439, 441, 448]; var lk = { sj: 0, dj: 1, jj: 2, kj: 4, pj: 8, lj: 16, mj: 32, rj: 64, qj: 128, fj: 256, hj: 512, oj: 1024, gj: 2048, ij: 4096, ej: 8192, nj: 16384 }; function mk(a) { I.call(this, a) }
    u(mk, I); function nk(a) { I.call(this, a) }
    u(nk, I); nk.prototype.setVideoId = function (a) { return Td(this, 1, ok, a) };
    nk.prototype.getPlaylistId = function () { return be(this, 2 === Ud(this, ok) ? 2 : -1) };
    ...
    var Tk = String(Rk); function Uk(a) {
        var b = []; ob(a, function (c, d) { var e = encodeURIComponent(String(d)), f; Array.isArray(c) ? f = c : f = [c]; fb(f, function (g) { "" == g ? b.push(e) : b.push(e + "=" + encodeURIComponent(String(g))) }) });
        return b.join("&")
    }
    ...
    ; function Zk(a) {
        var b = $k; a = void 0 === a ? B("yt.ads.biscotti.lastId_") || "" : a; var c = Object, d = c.assign, e = {}; e.dt = Rh; e.flash = "0"; a: { try { var f = b.h.top.location.href } catch (fa) { f = 2; break a } f = f ? f === b.i.location.href ? 0 : 1 : 2 } e = (e.frm = f, e); try {
            e.u_tz = -(new Date).getTimezoneOffset(); var g = void 0 === g ? Dh : g; try { var h = g.history.length } catch (fa) { h = 0 } e.u_his = h; var k; e.u_h = null == (k = Dh.screen) ? void 0 : k.height; var m; e.u_w = null == (m = Dh.screen) ? void 0 : m.width; var q; e.u_ah = null == (q = Dh.screen) ? void 0 : q.availHeight; var r; e.u_aw =
                null == (r = Dh.screen) ? void 0 : r.availWidth; var w; e.u_cd = null == (w = Dh.screen) ? void 0 : w.colorDepth
        } catch (fa) { } h = b.h; try { var t = h.screenX; var y = h.screenY } catch (fa) { } try { var E = h.outerWidth; var F = h.outerHeight } catch (fa) { } try { var O = h.innerWidth; var N = h.innerHeight } catch (fa) { } try { var Q = h.screenLeft; var ca = h.screenTop } catch (fa) { } try { O = h.innerWidth, N = h.innerHeight } catch (fa) { } try { var U = h.screen.availWidth; var lb = h.screen.availTop } catch (fa) { } t = [Q, ca, t, y, U, lb, E, F, O, N]; try {
            var Wa = (b.h.top || window).document, na = "CSS1Compat" ==
                Wa.compatMode ? Wa.documentElement : Wa.body; var H = (new jf(na.clientWidth, na.clientHeight)).round()
        } catch (fa) { H = new jf(-12245933, -12245933) } Wa = H; H = {}; var la = void 0 === la ? z : la; na = new Yh; la.SVGElement && la.document.createElementNS && na.set(0); y = Lh(); y["allow-top-navigation-by-user-activation"] && na.set(1); y["allow-popups-to-escape-sandbox"] && na.set(2); la.crypto && la.crypto.subtle && na.set(3); la.TextDecoder && la.TextEncoder && na.set(4); la = Zh(na); H.bc = la; H.bih = Wa.height; H.biw = Wa.width; H.brdim = t.join(); b = b.i; b = (H.vis =
    ...
    }, fl = "app debugcss debugjs expflag force_ad_params force_ad_encrypted force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address".split(" ").concat(ia(Sh)), gl = !1;
    function hl(a, b) {
        b = void 0 === b ? {} : b; var c = Yk(a), d = M("web_ajax_ignore_global_headers_if_set"), e; for (e in el) { var f = L(el[e]); "X-Goog-Visitor-Id" !== e || f || (f = L("VISITOR_DATA")); !f || !c && oc(a) || d && void 0 !== b[e] || (b[e] = f) } "X-Goog-EOM-Visitor-Id" in b && "X-Goog-Visitor-Id" in b && delete b["X-Goog-Visitor-Id"]; if (c || !oc(a)) b["X-YouTube-Utc-Offset"] = String(-(new Date).getTimezoneOffset()); if (c || !oc(a)) { try { var g = (new Intl.DateTimeFormat).resolvedOptions().timeZone } catch (h) { } g && (b["X-YouTube-Time-Zone"] = g) } document.location.hostname.endsWith("youtubeeducation.com") ||
            !c && oc(a) || (b["X-YouTube-Ad-Signals"] = Uk(Zk())); return b
    }
    function il(a) {
        var b = window.location.search, c = oc(a); M("debug_handle_relative_url_for_query_forward_killswitch") || !c && Yk(a) && (c = document.location.hostname); var d = mc(nc(5, a)); d = (c = c && (c.endsWith("youtube.com") || c.endsWith("youtube-nocookie.com"))) && d && d.startsWith("/api/"); if (!c || d) return a; var e = Vk(b), f = {}; fb(fl, function (g) { e[g] && (f[g] = e[g]) });
        return Xk(a, f || {}, !1)
    }
    function jl(a, b) {
        var c = b.format || "JSON"; a = kl(a, b); var d = ll(a, b), e = !1, f = ml(a, function (k) {
            if (!e) {
    ...
    function ll(a, b) {
        var c = L("XSRF_FIELD_NAME"), d = L("XSRF_TOKEN"), e = b.postBody || "", f = b.postParams, g = L("XSRF_FIELD_NAME"), h; b.headers && (h = b.headers["Content-Type"]); b.excludeXsrf || oc(a) && !b.withCredentials && oc(a) != document.location.hostname || "POST" != b.method || h && "application/x-www-form-urlencoded" != h || b.postParams && b.postParams[g] || (f || (f = {}), f[c] = d); (M("ajax_parse_query_data_only_when_filled") && f && 0 < Object.keys(f).length || f) && "string" === typeof e && (e = Vk(e), yb(e, f), e = b.postBodyFormat && "JSON" == b.postBodyFormat ?
            JSON.stringify(e) : tc(e)); f = e || f && !rb(f); !gl && f && "POST" != b.method && (gl = !0, Kk(Error("AJAX request with postData should use POST"))); return e
    }
    function nl(a, b, c, d) {
        var e = null; switch (b) { case "JSON": try { var f = c.responseText } catch (g) { throw d = Error("Error reading responseText"), d.params = a, Lk(d), g; } a = c.getResponseHeader("Content-Type") || ""; f && 0 <= a.indexOf("json") && (")]}'\n" === f.substring(0, 5) && (f = f.substring(5)), e = JSON.parse(f)); break; case "XML": if (a = (a = c.responseXML) ? ol(a) : null) e = {}, fb(a.getElementsByTagName("*"), function (g) { e[g.tagName] = pl(g) }) }d && ql(e);
        return e
    }
    ...
    function ml(a, b, c, d, e, f, g) {
        function h() { 4 == (k && "readyState" in k ? k.readyState : 0) && b && Jk(b)(k) }
    ...
    Na(xl); var Cl = { bluetooth: "CONN_DISCO", cellular: "CONN_CELLULAR_UNKNOWN", ethernet: "CONN_WIFI", none: "CONN_NONE", wifi: "CONN_WIFI", wimax: "CONN_CELLULAR_4G", other: "CONN_UNKNOWN", unknown: "CONN_UNKNOWN", "slow-2g": "CONN_CELLULAR_2G", "2g": "CONN_CELLULAR_2G", "3g": "CONN_CELLULAR_3G", "4g": "CONN_CELLULAR_4G" }, Dl = {
    ...
    ; var Sl = Xc || Yc; function Tl(a) { var b = Tb(); return b ? 0 <= b.toLowerCase().indexOf(a) : !1 }
    ...
    function rm(a, b, c, d) {
        b = gm(b); var e = a instanceof Error ? a : Error("Unexpected error: " + a); if (e instanceof nm) return e; a = { objectStoreNames: c, dbName: b, dbVersion: d }; if ("QuotaExceededError" === e.name) return new nm("QUOTA_EXCEEDED", a); if (Zc && "UnknownError" === e.name) return new nm("QUOTA_MAYBE_EXCEEDED", a); if (e instanceof pm) return new nm("MISSING_INDEX", Object.assign({}, a, { objectStore: e.objectStore, index: e.index })); if ("InvalidStateError" === e.name && qm.some(function (f) { return e.message.includes(f) })) return new nm("EXECUTE_TRANSACTION_ON_CLOSED_DB",
            a);
        if ("AbortError" === e.name) return new nm("UNKNOWN_ABORT", a, e.message); e.args = [Object.assign({}, a, { name: "IdbError", kc: e.name })]; e.level = "WARNING"; return e
    }
    ...
    l.update = function (a) { return Cm(this.cursor.update(a)) }; function Um(a, b, c) {
        return new Promise(function (d, e) {
            function f() { w || (w = new Fm(g.result, { closed: r })); return w }
            var g = void 0 !== b ? self.indexedDB.open(a, b) : self.indexedDB.open(a); var h = c.Jc, k = c.blocking, m = c.zd, q = c.upgrade, r = c.closed, w; g.addEventListener("upgradeneeded", function (t) {
                try {
    ...
    function Wm(a, b) {
        b = void 0 === b ? {} : b; var c, d, e, f; return x(function (g) {
            if (1 == g.h) return ya(g, 2), c = self.indexedDB.deleteDatabase(a), d = b, (e = d.Jc) && c.addEventListener("blocked", function () { e() }), v(g, Bm(c), 4);
    ...
    function an(a) {
        ...
        if (!a.l) throw Zm(a); if (a.h) return a.h; var d = {
            blocking: function (f) { f.close() },
            closed: c, zd: c, upgrade: a.options.upgrade
    ...
    function hn(a) {
        var b, c; return x(function (d) {
            if (1 == d.h) return b = Rl("YtIdbMeta hasAnyMeta other"), v(d, en(function (e) { return void 0 !== e.userIdentifier && e.userIdentifier !== b }, a), 2);
    ...
    function ln() {
        var a, b, c, d; return x(function (e) {
            switch (e.h) {
                case 1: a = Wl(); if (null == (b = a) ? 0 : b.hasSucceededOnce) return e.return(!0); var f; if (f = Sl) f = /WebKit\/([0-9]+)/.exec(Tb()), f = !!(f && 600 <= parseInt(f[1], 10)); f && (f = /WebKit\/([0-9]+)/.exec(Tb()), f = !(f && 602 <= parseInt(f[1], 10))); if (f || Kc) return e.return(!1); try { if (c = self, !(c.indexedDB && c.IDBIndex && c.IDBKeyRange && c.IDBObjectStore)) return e.return(!1) } catch (g) { return e.return(!1) } if (!("IDBTransaction" in self && "objectStoreNames" in IDBTransaction.prototype)) return e.return(!1);
    ...
    function wn(a, b, c) {
        a = a.map(function (d) { return x(function (e) { return 1 == e.h ? v(e, Wm(d.actualName, b), 2) : v(e, dn(d.actualName, c), 0) }) });
    ...
    zn.prototype.j = function (a, b, c) { c = void 0 === c ? {} : c; return (this.options.Jb ? un : tn)(a, b, Object.assign({}, c)) };
    ...
    function Ln(a) {
        var b = new Yi, c = new Ri; D(c, 1, a.fc); D(c, 2, a.ec); D(c, 16, a.Wc); D(c, 17, a.innertubeContextClientVersion); if (a.yb) { var d = a.yb, e = new Ni; d.coldConfigData && D(e, 1, d.coldConfigData); d.appInstallData && D(e, 6, d.appInstallData); d.coldHashData && D(e, 3, d.coldHashData); d.hotHashData && D(e, 5, d.hotHashData); G(c, Ni, 62, e) } (d = z.devicePixelRatio) && 1 != d && D(c, 65, d); d = Fk(); "" !== d && D(c, 54, d); d = Gk(); if (0 < d.length) {
            e = new Ti; for (var f = 0; f < d.length; f++) { var g = new Li; D(g, 1, d[f].key); Td(g, 2, Mi, d[f].value); ae(e, 15, Li, g) } G(b,
                Ti, 5, e)
        } Gn(a, c); Hn(c); In(a, c); Jn(c); M("start_sending_config_hash") && Kn(c); L("DELEGATED_SESSION_ID") && !M("pageid_as_header_web") && (a = new Wi, D(a, 3, L("DELEGATED_SESSION_ID"))); a = p(Object.entries(Vk(L("DEVICE", "")))); for (d = a.next(); !d.done; d = a.next())e = p(d.value), d = e.next().value, e = e.next().value, "cbrand" === d ? D(c, 12, e) : "cmodel" === d ? D(c, 13, e) : "cbr" === d ? D(c, 87, e) : "cbrver" === d ? D(c, 88, e) : "cos" === d ? D(c, 18, e) : "cosver" === d ? D(c, 19, e) : "cplatform" === d && D(c, 42, e); b.i(c); return b
    }
    function Gn(a, b, c) { a = a.dc; if ("WEB" === a || "MWEB" === a || 1 === a || 2 === a) if (b) { c = Vd(b, Oi, 96) || new Oi; var d = sl(); d = Object.keys(fj).indexOf(d); d = -1 === d ? null : d; null !== d && D(c, 3, d); G(b, Oi, 96, c) } else c && (c.client.mainAppWebInfo = null != (d = c.client.mainAppWebInfo) ? d : {}, c.client.mainAppWebInfo.webDisplayMode = sl()) }
    ...
    function In(a, b, c) { if (a.appInstallData) if (b) { var d; c = null != (d = Vd(b, Ni, 62)) ? d : new Ni; D(c, 6, a.appInstallData); G(b, Ni, 62, c) } else c && (c.client.configInfo = c.client.configInfo || {}, c.client.configInfo.appInstallData = a.appInstallData) }
    ...
    function Mn(a, b, c) { c = void 0 === c ? {} : c; var d = {}; L("EOM_VISITOR_DATA") ? d = { "X-Goog-EOM-Visitor-Id": L("EOM_VISITOR_DATA") } : d = { "X-Goog-Visitor-Id": c.visitorData || L("VISITOR_DATA", "") }; if (b && b.includes("www.youtube-nocookie.com")) return d; (b = c.ir || L("AUTHORIZATION")) || (a ? b = "Bearer " + B("gapi.auth.getToken")().hr : b = ug([])); b && (d.Authorization = b, d["X-Goog-AuthUser"] = L("SESSION_INDEX", 0), M("pageid_as_header_web") && (d["X-Goog-PageId"] = L("DELEGATED_SESSION_ID"))); return d }
    function Kn(a, b) { Cn.h || (Cn.h = new Cn); var c = B("yt.gcf.config.coldConfigData"); var d = B("yt.gcf.config.hotHashData"); var e = B("yt.gcf.config.coldHashData"); if (c && e && d) if (a) { var f; b = null != (f = Vd(a, Ni, 62)) ? f : new Ni; D(b, 1, c); D(b, 3, e); D(b, 5, d); G(a, Ni, 62, b) } else b && (b.client.configInfo = b.client.configInfo || {}, b.client.configInfo.coldConfigData = c, b.client.configInfo.coldHashData = e, b.client.configInfo.hotHashData = d) }
    ; function Nn(a) { a = Object.assign({}, a); delete a.Authorization; var b = ug(); if (b) { var c = new ci; c.update(L("INNERTUBE_API_KEY")); c.update(b); a.hash = bd(c.digest(), 3) } return a }
    ...
    ; function Un(a) {
        this.ab = this.h = !1; this.potentialEsfErrorCounter = this.i = 0; this.handleError = function () { };
        this.Da = function () { };
        this.now = Date.now; this.Ka = !1; var b; this.vc = null != (b = a.vc) ? b : 100; var c; this.pc = null != (c = a.pc) ? c : 1; var d; this.nc = null != (d = a.nc) ? d : 2592E6; var e; this.lc = null != (e = a.lc) ? e : 12E4; var f; this.oc = null != (f = a.oc) ? f : 5E3; var g; this.H = null != (g = a.H) ? g : void 0; this.fb = !!a.fb; var h; this.eb = null != (h = a.eb) ? h : .1; var k; this.kb = null != (k = a.kb) ? k : 10; a.handleError && (this.handleError = a.handleError); a.Da && (this.Da = a.Da); a.Ka && (this.Ka = a.Ka); a.ab && (this.ab = a.ab); this.J = a.J; this.Z = a.Z; this.N = a.N; this.L = a.L; this.ja = a.ja; this.Db =
            a.Db; this.Cb = a.Cb; Vn(this) && (!this.J || this.J("networkless_logging")) && Wn(this)
    }
    function Wn(a) { Vn(a) && !a.Ka && (a.h = !0, a.fb && Math.random() <= a.eb && a.N.Lc(a.H), Xn(a), a.L.V() && a.Qa(), a.L.ia(a.Db, a.Qa.bind(a)), a.L.ia(a.Cb, a.Rb.bind(a))) }
    l = Un.prototype; l.writeThenSend = function (a, b) {
        var c = this; b = void 0 === b ? {} : b; if (Vn(this) && this.h) {
            var d = { url: a, options: b, timestamp: this.now(), status: "NEW", sendCount: 0 }; this.N.set(d, this.H).then(function (e) { d.id = e; c.L.V() && Yn(c, d) }).catch(function (e) {
                Yn(c, d);
                Zn(c, e)
            })
        } else this.ja(a, b)
    ...
    l.sendThenWrite = function (a, b, c) {
        var d = this; b = void 0 === b ? {} : b; if (Vn(this) && this.h) {
            var e = { url: a, options: b, timestamp: this.now(), status: "NEW", sendCount: 0 }; this.J && this.J("nwl_skip_retry") && (e.skipRetry = c); if (this.L.V() || this.J && this.J("nwl_aggressive_send_then_write") && !e.skipRetry) {
                if (!e.skipRetry) {
                    var f = b.onError ? b.onError : function () { };
                    b.onError = function (g, h) {
                        return x(function (k) {
                            if (1 == k.h) return v(k, d.N.set(e, d.H).catch(function (m) { Zn(d, m) }), 2);
                            f(g, h); k.h = 0
                        })
                    }
    ...
    l.sendAndWrite = function (a, b) {
        var c = this; b = void 0 === b ? {} : b; if (Vn(this) && this.h) {
            ...
            this.ja(d.url, d.options); this.N.set(d, this.H).then(function (g) { d.id = g; e && c.N.Ca(d.id, c.H) }).catch(function (g) { Zn(c, g) })
        } else this.ja(a, b)
    };
    l.Qa = function () { var a = this; if (!Vn(this)) throw sm("throttleSend"); this.i || (this.i = this.Z.U(function () { var b; return x(function (c) { if (1 == c.h) return v(c, a.N.cc("NEW", a.H), 2); if (3 != c.h) return b = c.i, b ? v(c, Yn(a, b), 3) : (a.Rb(), c.return()); a.i && (a.i = 0, a.Qa()); c.h = 0 }) }, this.vc)) };
    l.Rb = function () { this.Z.fa(this.i); this.i = 0 };
    function Yn(a, b) {
        var c, d; return x(function (e) {
            switch (e.h) {
                case 1: if (!Vn(a)) throw c = sm("immediateSend"), c; if (void 0 === b.id) { e.A(2); break } return v(e, a.N.cd(b.id, a.H), 3); case 3: (d = e.i) ? b = d : a.Da(Error("The request cannot be found in the database.")); case 2: if ($n(a, b, a.nc)) { e.A(4); break } a.Da(Error("Networkless Logging: Stored logs request expired age limit")); if (void 0 === b.id) { e.A(5); break } return v(e, a.N.Ca(b.id, a.H), 5); case 5: return e.return(); case 4: b.skipRetry || (b = ao(a, b)); if (!b) { e.A(0); break } if (!b.skipRetry ||
                    void 0 === b.id) { e.A(8); break } return v(e, a.N.Ca(b.id, a.H), 8); case 8: a.ja(b.url, b.options, !!b.skipRetry), e.h = 0
            }
        })
    }
    function ao(a, b) {
        if (!Vn(a)) throw sm("updateRequestHandlers"); var c = b.options.onError ? b.options.onError : function () { };
        b.options.onError = function (e, f) {
            var g, h, k; return x(function (m) {
                switch (m.h) {
                    case 1: g = bo(f); if (!(a.J && a.J("nwl_consider_error_code") && g || a.J && !a.J("nwl_consider_error_code") && a.potentialEsfErrorCounter <= a.kb)) { m.A(2); break } if (!a.L.nb) { m.A(3); break } return v(m, a.L.nb(), 3); case 3: if (a.L.V()) { m.A(2); break } c(e, f); if (!a.J || !a.J("nwl_consider_error_code") || void 0 === (null == (h = b) ? void 0 : h.id)) { m.A(6); break } return v(m, a.N.Hb(b.id, a.H, !1), 6); case 6: return m.return(); case 2: if (a.J && a.J("nwl_consider_error_code") &&
    ...
    function Xn(a) { if (!Vn(a)) throw sm("retryQueuedRequests"); a.N.cc("QUEUED", a.H).then(function (b) { b && !$n(a, b, a.lc) ? a.Z.U(function () { return x(function (c) { if (1 == c.h) return void 0 === b.id ? c.A(2) : v(c, a.N.Hb(b.id, a.H), 2); Xn(a); c.h = 0 }) }) : a.L.V() && a.Qa() }) }
    function Zn(a, b) { a.Ac && !a.L.V() ? a.Ac(b) : a.handleError(b) }
    ...
    function lo(a) {
        var b = mo, c = ko(); if (!c) return 0; var d = c.subscribe(b.toString(), function (e, f) {
            var g = B("ytPubsub2Pubsub2SkipSubKey"); g && g == d || (g = function () {
                if (go[d]) try {
                    if (f && b instanceof eo && b != e) try {
                        var h = b.h, k = f; if (!k.args || !k.version) throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete."); try { if (!h.ra) { var m = new h; h.ra = m.version } var q = h.ra } catch (F) { } if (!q || k.version != q) throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible."); try {
    ...
    function no() {
        var a = oo, b = lo(function (c) { a.apply(void 0, arguments); po(b) });
        return b
    }
    ...
    ; var qo;
    function ro() {
        if (qo) return qo(); var a = {}; qo = Bn("LogsDatabaseV2", {
    ...
    function to(a, b) { var c, d, e, f; return x(function (g) { if (1 == g.h) return c = { startTime: R(), transactionType: "YT_IDB_TRANSACTION_TYPE_WRITE" }, v(g, so(b), 2); if (3 != g.h) return d = g.i, e = Object.assign({}, a, { options: JSON.parse(JSON.stringify(a.options)), interface: L("INNERTUBE_CONTEXT_CLIENT_NAME", 0) }), v(g, Jm(d, e), 3); f = g.i; c.Bd = R(); uo(c); return g.return(f) }) }
    function vo(a, b) {
        var c, d, e, f, g, h, k; return x(function (m) {
            if (1 == m.h) return c = { startTime: R(), transactionType: "YT_IDB_TRANSACTION_TYPE_READ" }, v(m, so(b), 2); if (3 != m.h) return d = m.i, e = L("INNERTUBE_CONTEXT_CLIENT_NAME", 0), f = [a, e, 0], g = [a, e, R()], h = IDBKeyRange.bound(f, g), k = void 0, v(m, Gm(d, ["LogsRequestsStore"], { mode: "readwrite", T: !0 }, function (q) {
                return Sm(q.objectStore("LogsRequestsStore").index("newRequestV2"), { query: h, direction: "prev" }, function (r) {
                    r.getValue() && (k = r.getValue(), "NEW" === a && (k.status = "QUEUED",
                        r.update(k)))
                })
            }), 3);
            c.Bd = R(); uo(c); return m.return(k)
        })
    }
    ...
    ; var Bo = {}, Co = Bn("ServiceWorkerLogsDatabase", {
        Na: (Bo.SWHealthLog = { rb: 1 }, Bo), Jb: !0, upgrade: function (a, b) { b(1) && Hm(a, "SWHealthLog", { keyPath: "id", autoIncrement: !0 }).h.createIndex("swHealthNewRequest", ["interface", "timestamp"], { unique: !1 }) },
        version: 1
    }); function Do(a) { return $m(Co(), a) }
    ...
    ; var Go = {}, Ho = 0; function Io(a) {
        var b = new Image, c = "" + Ho++; Go[c] = b; b.onload = b.onerror = function () { delete Go[c] };
        b.src = a
    }
    ...
    l.nb = function (a) {
        a = Uh(this.i, a); a.then(function (b) { M("use_cfr_monitor") && Ko().requestComplete("generate_204", b) });
        return a
    };
    Oo.prototype.sendNetworkCheckRequest = Oo.prototype.nb; Oo.prototype.listen = Oo.prototype.ia; Oo.prototype.enableErrorFlushing = Oo.prototype.Pc; Oo.prototype.getWindowStatus = Oo.prototype.Uc; Oo.prototype.networkStatusHint = Oo.prototype.xa; Oo.prototype.isNetworkAvailable = Oo.prototype.V; Oo.getInstance = Po; function Qo(a) { a = void 0 === a ? {} : a; bf.call(this); var b = this; this.i = this.o = 0; this.j = Po(); var c = B("yt.networkStatusManager.instance.listen").bind(this.j); c && (a.mb ? (this.mb = a.mb, c("networkstatus-online", function () { Ro(b, "publicytnetworkstatus-online") }), c("networkstatus-offline", function () { Ro(b, "publicytnetworkstatus-offline") })) : (c("networkstatus-online", function () { cf(b, "publicytnetworkstatus-online") }), c("networkstatus-offline", function () { cf(b, "publicytnetworkstatus-offline") }))) }
    ...
    Qo.prototype.nb = function (a) { var b = this, c; return x(function (d) { c = B("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(b.j); return M("skip_network_check_if_cfr") && Ko().isEndpointCFR("generate_204") ? d.return(new Promise(function (e) { var f; b.xa((null == (f = window.navigator) ? void 0 : f.onLine) || !0); e(b.V()) })) : c ? d.return(c(a)) : d.return(!0) }) };
    function Ro(a, b) { a.mb ? a.i ? (Xh.fa(a.o), a.o = Xh.U(function () { a.m !== b && (cf(a, b), a.m = b, a.i = R()) }, a.mb - (R() - a.i))) : (cf(a, b), a.m = b, a.i = R()) : cf(a, b) }
    ; var So; function To() { var a = Un.call; So || (So = new Qo({ wr: !0, qr: !0 })); a.call(Un, this, { N: { Lc: zo, Ca: yo, cc: vo, cd: wo, Hb: xo, set: to }, L: So, handleError: Kk, Da: Lk, ja: Uo, now: R, Ac: No, Z: Pl(), Db: "publicytnetworkstatus-online", Cb: "publicytnetworkstatus-offline", fb: !0, eb: .1, kb: Ek("potential_esf_error_limit", 10), J: M, Ka: !(Ql() && Vo()) }); this.j = new Bh; M("networkless_immediately_drop_all_requests") && Ao(); yn("LogsDatabaseV2") }
    u(To, Un); function Wo() {
        var a = B("yt.networklessRequestController.instance"); a || (a = new To, A("yt.networklessRequestController.instance", a), M("networkless_logging") && nn().then(function (b) { a.H = b; Wn(a); a.j.resolve(); a.fb && Math.random() <= a.eb && a.H && Eo(a.H); M("networkless_immediately_drop_sw_health_store") && Xo(a) }));
        return a
    }
    ...
    function Uo(a, b, c) {
        M("use_cfr_monitor") && Yo(a, b); if (M("use_request_time_ms_header")) b.headers && (b.headers["X-Goog-Request-Time"] = JSON.stringify(Math.round(R()))); else { var d; if (null == (d = b.postParams) ? 0 : d.requestTimeMs) b.postParams.requestTimeMs = Math.round(R()) } if (c && 0 === Object.keys(b).length) {
            var e = void 0 === e ? "" : e; var f = void 0 === f ? !1 : f; if (a) if (e) ml(a, void 0, "POST", e); else if (L("USE_NET_AJAX_FOR_PING_TRANSPORT", !1)) ml(a, void 0, "GET", "", void 0, void 0, f); else {
                b: {
                    try {
                        var g = new bb({ url: a }); if (g.j && g.i ||
                            g.l) { var h = mc(nc(5, a)), k; if (!(k = !h || !h.endsWith("/aclk"))) { var m = a.search(Bc), q = Ac(a, 0, "ri", m); if (0 > q) var r = null; else { var w = a.indexOf("&", q); if (0 > w || w > m) w = m; r = decodeURIComponent(a.slice(q + 3, -1 !== w ? w : 0).replace(/\+/g, " ")) } k = "1" !== r } var t = !k; break b }
                    } catch (E) { } t = !1
                } if (t) { b: { try { if (window.navigator && window.navigator.sendBeacon && window.navigator.sendBeacon(a, "")) { var y = !0; break b } } catch (E) { } y = !1 } c = y ? !0 : !1 } else c = !1; c || Io(a)
            }
        } else jl(a, b)
    }
    function Yo(a, b) {
    ...
    ; var Zo = !1, $o = z.ytNetworklessLoggingInitializationOptions || { isNwlInitialized: Zo }; A("ytNetworklessLoggingInitializationOptions", $o); function ap() { var a; x(function (b) { if (1 == b.h) return v(b, nn(), 2); a = b.i; if (!a || !Ql() && !M("nwl_init_require_datasync_id_killswitch") || !Vo()) return b.A(0); Zo = !0; $o.isNwlInitialized = Zo; return v(b, Wo().awaitInitialization(), 0) }) }
    ; function op(a) { var b = this; this.config_ = null; a ? this.config_ = a : Dn() && (this.config_ = En()); Kl(function () { Sn(b) }, 5E3) }
    op.prototype.isReady = function () { !this.config_ && Dn() && (this.config_ = En()); return !!this.config_ };
    function Tn(a, b, c, d) {
        function e(y) {
            y = void 0 === y ? !1 : y; var E; if (d.retry && "www.youtube-nocookie.com" != h && (y || M("skip_ls_gel_retry") || "application/json" !== g.headers["Content-Type"] || (E = Qn(b, c, m, k)), E)) {
                var F = g.onSuccess, O = g.onFetchSuccess; g.onSuccess = function (N, Q) { Rn(E); F(N, Q) };
                c.onFetchSuccess = function (N, Q) { Rn(E); O(N, Q) }
            } try { y && d.retry && !d.ic.bypassNetworkless ? (g.method = "POST", d.ic.writeThenSend ? Wo().writeThenSend(t, g) : Wo().sendAndWrite(t, g)) : M("web_all_payloads_via_jspb") ? jl(t, g) : (g.method = "POST", g.postParams || (g.postParams = {}), jl(t, g)) } catch (N) {
                if ("InvalidAccessError" == N.name) E && (Rn(E), E = 0), Lk(Error("An extension is blocking network request."));
                else throw N;
            } E && Kl(function () { Sn(a) }, 5E3)
        }
        !L("VISITOR_DATA") && "visitor_id" !== b && .01 > Math.random() && Lk(new P("Missing VISITOR_DATA when sending innertube request.", b, c, d)); if (!a.isReady()) { var f = new P("innertube xhrclient not ready", b, c, d); Kk(f); throw f; } var g = {
    ...
    function Qp(a) {
        this.type = ""; this.state = this.source = this.data = this.currentTarget = this.relatedTarget = this.target = null; this.charCode = this.keyCode = 0; this.metaKey = this.shiftKey = this.ctrlKey = this.altKey = !1; this.rotation = this.clientY = this.clientX = 0; this.scale = 1; this.changedTouches = this.touches = null; try {
            if (a = a || window.event) {
                this.event = a; for (var b in a) b in Pp || (this[b] = a[b]); this.scale = a.scale; this.rotation = a.rotation; var c = a.target || a.srcElement; c && 3 == c.nodeType && (c = c.parentNode); this.target = c; var d = a.relatedTarget;
    ...
    function Vp(a, b, c, d) {
        d = void 0 === d ? {} : d; if (!a || !a.addEventListener && !a.attachEvent) return ""; var e = Tp(a, b, c, d); if (e) return e; e = ++Sp.count + ""; var f = !("mouseenter" != b && "mouseleave" != b || !a.addEventListener || "onmouseenter" in document); var g = f ? function (h) { h = new Qp(h); if (!mf(h.relatedTarget, function (k) { return k == a })) return h.currentTarget = a, h.type = b, c.call(a, h) } : function (h) {
            h = new Qp(h);
    ...
    function $p(a) {
        var b = void 0 === a ? {} : a; a = void 0 === b.gd ? !1 : b.gd; b = void 0 === b.Qc ? !0 : b.Qc; if (null == B("_lact", window)) {
            var c = parseInt(L("LACT"), 10); c = isFinite(c) ? Date.now() - Math.max(c, 0) : -1; A("_lact", c, window); A("_fact", c, window); -1 == c && aq(); Vp(document, "keydown", aq); Vp(document, "keyup", aq); Vp(document, "mousedown", aq); Vp(document, "mouseup", aq); a ? Vp(window, "touchmove", function () { bq("touchmove", 200) }, { passive: !0 }) : (Vp(window, "resize", function () { bq("resize", 200) }), b && Vp(window, "scroll", function () { bq("scroll", 200) }));
    ...
    ; var dq = z.ytPubsubPubsubInstance || new K, eq = z.ytPubsubPubsubSubscribedKeys || {}, fq = z.ytPubsubPubsubTopicToKeys || {}, gq = z.ytPubsubPubsubIsSynchronous || {}; function hq(a, b) {
        var c = iq(); if (c && b) {
            var d = c.subscribe(a, function () {
                var e = arguments; var f = function () { eq[d] && b.apply && "function" == typeof b.apply && b.apply(window, e) };
                try { gq[a] ? f() : dl(f, 0) } catch (g) { Kk(g) }
            }, void 0);
            eq[d] = !0; fq[a] || (fq[a] = []); fq[a].push(d); return d
        } return 0
    }
    ...
    function Hq(a, b) { var c = ""; if (a.Ja) c = "visitorOnlyApprovedKey"; else if (a.cttAuthInfo) { if (void 0 === b ? 0 : b) { b = a.cttAuthInfo.token; c = a.cttAuthInfo; var d = new nk; c.videoId ? d.setVideoId(c.videoId) : c.playlistId && Td(d, 2, ok, c.playlistId); Cq[b] = d } else b = a.cttAuthInfo, c = {}, b.videoId ? c.videoId = b.videoId : b.playlistId && (c.playlistId = b.playlistId), Bq[a.cttAuthInfo.token] = c; c = a.cttAuthInfo.token } return c }
    function Lq(a, b, c) {
        a = void 0 === a ? {} : a; c = void 0 === c ? !1 : c; !c && M("web_all_payloads_via_jspb") && Lk(new P("transport.flushLogs called for JSON in JSPB only experiment")); new yf(function (d, e) {
            c ? (Rq(wq.i), Rq(wq.h), wq.h = 0) : (Rq(vq.i), Rq(vq.h), vq.h = 0); if (tq && tq.isReady()) if (M("use_new_in_memory_storage")) {
                var f = a, g = c, h = tq; f = void 0 === f ? {} : f; g = void 0 === g ? !1 : g; var k = new Map, m = new Map; if (void 0 !== b) g ? (e = Eq().extractMatchingEntries({ isJspb: g, cttAuthInfo: b }), k.set(b, e), Qq(k, h, d, f)) : (k = Eq().extractMatchingEntries({
                    isJspb: g,
                    cttAuthInfo: b
                }), m.set(b, k), Oq(m, h, d, e, f)); else if (g) { e = p(Object.keys(Dq)); for (g = e.next(); !g.done; g = e.next())m = g.value, g = Eq().extractMatchingEntries({ isJspb: !0, cttAuthInfo: m }), 0 < g.length && k.set(m, g), delete Dq[m]; Qq(k, h, d, f) } else { k = p(Object.keys(Dq)); for (g = k.next(); !g.done; g = k.next()) { g = g.value; var q = Eq().extractMatchingEntries({ isJspb: !1, cttAuthInfo: g }); 0 < q.length && m.set(g, q); delete Dq[g] } Oq(m, h, d, e, f) }
    ...
    function Mq(a) {
        a = void 0 === a ? !1 : a; if (M("web_gel_timeout_cap") && (!a && !vq.h || a && !wq.h)) {
            var b = Kq(function () { Lq({ writeThenSend: !0 }, void 0, a) }, 6E4);
            a ? wq.h = b : vq.h = b
        } Rq(a ? wq.i : vq.i); b = L("LOGGING_BATCH_TIMEOUT", Ek("web_gel_debounce_ms", 1E4)); M("shorten_initial_gel_batch_timeout") && yq && (b = rq); b = Kq(function () { Lq({ writeThenSend: !0 }, void 0, a) }, b);
        a ? wq.i = b : vq.i = b
    }
    function Oq(a, b, c, d, e, f) {
        e = void 0 === e ? {} : e; var g = Math.round(R()), h = a.size, k = {}; a = p(a); for (var m = a.next(); !m.done; k = { Ta: k.Ta, sa: k.sa, Fa: k.Fa, Va: k.Va, Ua: k.Ua }, m = a.next()) {
            var q = p(m.value); m = q.next().value; q = q.next().value; k.sa = wb({ context: Fn(b.config_ || En()) }); if (!Pa(q) && !M("throw_err_when_logevent_malformed_killswitch")) { d(); break } k.sa.events = q; (q = Bq[m]) && Sq(k.sa, m, q); delete Bq[m]; k.Fa = "visitorOnlyApprovedKey" === m; Tq(k.sa, g, k.Fa); Uq(e); k.Va = function () { h--; h || c() };
    ...
    function Qq(a, b, c, d, e) {
        d = void 0 === d ? {} : d; var f = Math.round(R()), g = a.size, h = new Map([].concat(ia(a))); h = p(h); for (var k = h.next(); !k.done; k = h.next()) {
            var m = p(k.value).next().value, q = a.get(m); k = new pk; var r = Ln(b.config_ || En()); G(k, Yi, 1, r); q = q ? Wq(q) : []; q = p(q); for (r = q.next(); !r.done; r = q.next())ae(k, 3, jk, r.value); (q = Cq[m]) && Xq(k, m, q); delete Cq[m]; m = "visitorOnlyApprovedKey" === m; Yq(k, f, m); Uq(d); k = ie(k); m = Vq(d, m, function () { g--; g || c() }, function () {
                g--;
                g || c()
            }, e);
    ...
    function Vq(a, b, c, d, e) { a = { retry: !0, onSuccess: c, onError: d, ic: a, Ja: b, kr: !!e, headers: {}, postBodyFormat: "", postBody: "" }; Zq() && (a.headers["X-Goog-Request-Time"] = JSON.stringify(Math.round(R()))); return a }
    ...
    function Xq(a, b, c) { if (be(c, 1 === Ud(c, ok) ? 1 : -1)) var d = 1; else if (c.getPlaylistId()) d = 2; else return; G(a, nk, 4, c); a = Vd(a, Yi, 1) || new Yi; c = Vd(a, Wi, 3) || new Wi; var e = new Vi; D(e, 2, b); D(e, 1, d); ae(c, 12, Vi, e); G(a, Wi, 3, c) }
    ...
    function br(a, b, c, d) { d = void 0 === d ? {} : d; var e = {}, f = Math.round(d.timestamp || R()); e.eventTimeMs = f < Number.MAX_SAFE_INTEGER ? f : 0; e[a] = b; M("enable_unknown_lact_fix_on_html5") && $p(); a = cq(); e.context = { lastActivityMs: String(d.timestamp || !isFinite(a) ? -1 : a) }; M("log_sequence_info_on_gel_web") && d.aa && (a = e.context, b = d.aa, b = { index: cr(b), groupKey: b }, a.sequence = b, d.Yb && delete ar[d.aa]); (d.qc ? Nq : Fq)({ endpoint: "log_event", payload: e, cttAuthInfo: d.cttAuthInfo, Ja: d.Ja }, c) }
    function dr(a) { Lq(void 0, void 0, void 0 === a ? !1 : a) }
    function cr(a) { ar[a] = a in ar ? ar[a] + 1 : 0; return ar[a] }
    ; var er = []; var fr = z.ytLoggingGelSequenceIdObj_ || {}; A("ytLoggingGelSequenceIdObj_", fr); function gr(a, b, c) { c = void 0 === c ? {} : c; var d = Math.round(c.timestamp || R()); D(a, 1, d < Number.MAX_SAFE_INTEGER ? d : 0); var e = cq(); d = new ik; D(d, 1, c.timestamp || !isFinite(e) ? -1 : e); if (M("log_sequence_info_on_gel_web") && c.aa) { e = c.aa; var f = cr(e), g = new Nj; D(g, 2, f); D(g, 1, e); G(d, Nj, 3, g); c.Yb && delete fr[c.aa] } G(a, ik, 33, d); (c.qc ? Pq : Jq)({ endpoint: "log_event", payload: a, cttAuthInfo: c.cttAuthInfo, Ja: c.Ja }, b) }
    ; function hr(a, b) { b = void 0 === b ? {} : b; var c = !1; L("ytLoggingEventsDefaultDisabled", !1) && (c = !0); gr(a, c ? null : op, b) }
    ; function ir(a, b) { var c = new jk; Zd(c, Ej, 72, kk, a); hr(c, b) }
    function jr(a, b, c) { var d = new jk; Zd(d, Dj, 73, kk, a); c ? gr(d, c, b) : hr(d, b) }
    function kr(a, b, c) { var d = new jk; Zd(d, Cj, 78, kk, a); c ? gr(d, c, b) : hr(d, b) }
    function lr(a, b, c) { var d = new jk; Zd(d, Fj, 208, kk, a); c ? gr(d, c, b) : hr(d, b) }
    function mr(a, b, c) { var d = new jk; Zd(d, vj, 156, kk, a); c ? gr(d, c, b) : hr(d, b) }
    function nr(a, b, c) { var d = new jk; Zd(d, zj, 215, kk, a); c ? gr(d, c, b) : hr(d, b) }
    function or(a, b, c) { var d = new jk; Zd(d, uj, 111, kk, a); c ? gr(d, c, b) : hr(d, b) }
    ; function cm(a, b, c) { c = void 0 === c ? {} : c; if (M("migrate_events_to_ts")) { c = void 0 === c ? {} : c; var d = op; L("ytLoggingEventsDefaultDisabled", !1) && op === op && (d = null); M("web_all_payloads_via_jspb") ? er.push({ Eb: a, payload: b, options: c }) : br(a, b, d, c) } else d = op, L("ytLoggingEventsDefaultDisabled", !1) && op == op && (d = null), br(a, b, d, c) }
    ; var pr = [{
        ...
        jb: { ReferenceError: [{ regexp: /(.*) is not defined/, groups: ["key"] }, { regexp: /Can't find variable: (.*)/, groups: ["key"] }] }
    }]; var rr = { oa: [], ma: [{ callback: qr, weight: 500 }] }; function qr(a) { if ("JavaException" === a.name) return !0; a = a.stack; return a.includes("chrome://") || a.includes("chrome-extension://") || a.includes("moz-extension://") }
            ...
            a.hasOwnProperty("level") && a.level && (h = a.level); if (M("console_log_js_exceptions")) {
                ...
                var m = Fr, q = ve(a), r = q.message || "Unknown Error", w = q.name || "UnknownError", t = q.stack || a.i || "Not available"; if (t.startsWith(w + ": " + r)) { var y = t.split("\n"); y.shift(); t = y.join("\n") } var E = q.lineNumber || "Not available", F = q.fileName || "Not available", O = t, N = 0; if (a.hasOwnProperty("args") && a.args && a.args.length) for (var Q = 0; Q < a.args.length && !(N = yr(a.args[Q], "params." + Q, g, N), 500 <= N); Q++); else if (a.hasOwnProperty("params") &&
                    a.params) { var ca = a.params; if ("object" === typeof a.params) for (var U in ca) { if (ca[U]) { var lb = "params." + U, Wa = Ar(ca[U]); g[lb] = Wa; N += lb.length + Wa.length; if (500 < N) break } } else g.params = Ar(ca) } if (m.length) for (var na = 0; na < m.length && !(N = yr(m[na], "params.context." + na, g, N), 500 <= N); na++); navigator.vendor && !g.hasOwnProperty("vendor") && (g["device.vendor"] = navigator.vendor); var H = { message: r, name: w, lineNumber: E, fileName: F, stack: O, params: g, sampleWeight: 1 }, la = Number(a.columnNumber); isNaN(la) || (H.lineNumber = H.lineNumber +
                        ":" + la); if ("IGNORED" === a.level) var fa = 0; else a: { for (var xe = ur(), ye = p(xe.oa), nd = ye.next(); !nd.done; nd = ye.next()) { var pa = nd.value; if (H.message && H.message.match(pa.xr)) { fa = pa.weight; break a } } for (var bp = p(xe.ma), Oj = bp.next(); !Oj.done; Oj = bp.next()) { var cp = Oj.value; if (cp.callback(H)) { fa = cp.weight; break a } } fa = 1 } H.sampleWeight = fa; for (var dp = p(pr), Pj = dp.next(); !Pj.done; Pj = dp.next()) {
                            var Qj = Pj.value; if (Qj.jb[H.name]) for (var ep = p(Qj.jb[H.name]), Rj = ep.next(); !Rj.done; Rj = ep.next()) {
                                var fp = Rj.value, Ig = H.message.match(fp.regexp);
                                if (Ig) { H.params["params.error.original"] = Ig[0]; for (var Sj = fp.groups, gp = {}, od = 0; od < Sj.length; od++)gp[Sj[od]] = Ig[od + 1], H.params["params.error." + Sj[od]] = Ig[od + 1]; H.message = Qj.Bb(gp); break }
                            }
                        } H.params || (H.params = {}); var hp = ur(); H.params["params.errorServiceSignature"] = "msg=" + hp.oa.length + "&cb=" + hp.ma.length; H.params["params.serviceWorker"] = "false"; z.document && z.document.querySelectorAll && (H.params["params.fscripts"] = String(document.querySelectorAll("script:not([nonce])").length)); Db("sample").constructor !==
                            Bb && (H.params["params.fconst"] = "true"); window.yterr && "function" === typeof window.yterr && window.yterr(H); if (0 !== H.sampleWeight && !Br.has(H.message)) {
                                if ("ERROR" === h) {
                                    vr.ta("handleError", H); if (M("record_app_crashed_web") && 0 === Er && 1 === H.sampleWeight) if (Er++, M("errors_via_jspb")) {
                                        var Tj = new rj; D(Tj, 1, 1); if (!M("report_client_error_with_app_crash_ks")) { var ip = new mj; D(ip, 1, H.message); var jp = new nj; G(jp, mj, 3, ip); var kp = new oj; G(kp, nj, 5, jp); var lp = new pj; G(lp, oj, 9, kp); G(Tj, pj, 4, lp) } var mp = new jk; Zd(mp, rj, 20,
                                            kk, Tj); hr(mp)
                                    } else { var np = { appCrashType: "APP_CRASH_TYPE_BREAKPAD" }; M("report_client_error_with_app_crash_ks") || (np.systemHealth = { crashData: { clientError: { logMessage: { message: H.message } } } }); cm("appCrashed", np) } Dr++
                                } else "WARNING" === h && vr.ta("handleWarning", H); if (M("kevlar_gel_error_routing")) a: {
                                    var ze = h; if (M("errors_via_jspb")) {
                                        if (Jr()) var pp = void 0; else {
                                            var pd = new jj; D(pd, 1, H.stack); H.fileName && D(pd, 4, H.fileName); var Gb = H.lineNumber && H.lineNumber.split ? H.lineNumber.split(":") : []; 0 !== Gb.length && (1 !==
                                                Gb.length || isNaN(Number(Gb[0])) ? 2 !== Gb.length || isNaN(Number(Gb[0])) || isNaN(Number(Gb[1])) || (D(pd, 2, Number(Gb[0])), D(pd, 3, Number(Gb[1]))) : D(pd, 2, Number(Gb[0]))); var wc = new mj; D(wc, 1, H.message); D(wc, 3, H.name); D(wc, 6, H.sampleWeight); "ERROR" === ze ? D(wc, 2, 2) : "WARNING" === ze ? D(wc, 2, 1) : D(wc, 2, 0); var Uj = new kj; D(Uj, 1, !0); Zd(Uj, jj, 3, lj, pd); var Yb = new gj; D(Yb, 3, window.location.href); for (var qp = L("FEXP_EXPERIMENTS", []), Vj = 0; Vj < qp.length; Vj++) { var Ev = qp[Vj]; Id(Yb); Sd(Yb, 5, 2, !1).push(Ev) } var Wj = L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
                                            if (!Ck() && Wj) for (var rp = p(Object.keys(Wj)), xc = rp.next(); !xc.done; xc = rp.next()) { var sp = xc.value, Xj = new ij; D(Xj, 1, sp); D(Xj, 2, String(Wj[sp])); ae(Yb, 4, ij, Xj) } var Yj = H.params; if (Yj) { var tp = p(Object.keys(Yj)); for (xc = tp.next(); !xc.done; xc = tp.next()) { var up = xc.value, Zj = new ij; D(Zj, 1, "client." + up); D(Zj, 2, String(Yj[up])); ae(Yb, 4, ij, Zj) } } var vp = L("SERVER_NAME"), wp = L("SERVER_VERSION"); if (vp && wp) {
                                                var ak = new ij; D(ak, 1, "server.name"); D(ak, 2, vp); ae(Yb, 4, ij, ak); var bk = new ij; D(bk, 1, "server.version"); D(bk, 2, wp); ae(Yb,
                                                    4, ij, bk)
                                            } var Jg = new nj; G(Jg, gj, 1, Yb); G(Jg, kj, 2, Uj); G(Jg, mj, 3, wc); pp = Jg
                                        } var xp = pp; if (!xp) break a; var yp = new jk; Zd(yp, nj, 163, kk, xp); hr(yp)
                                    } else {
                                        if (Jr()) var zp = void 0; else {
                                            var Ae = { stackTrace: H.stack }; H.fileName && (Ae.filename = H.fileName); var Hb = H.lineNumber && H.lineNumber.split ? H.lineNumber.split(":") : []; 0 !== Hb.length && (1 !== Hb.length || isNaN(Number(Hb[0])) ? 2 !== Hb.length || isNaN(Number(Hb[0])) || isNaN(Number(Hb[1])) || (Ae.lineNumber = Number(Hb[0]), Ae.columnNumber = Number(Hb[1])) : Ae.lineNumber = Number(Hb[0]));
                                            var ck = { level: "ERROR_LEVEL_UNKNOWN", message: H.message, errorClassName: H.name, sampleWeight: H.sampleWeight }; "ERROR" === ze ? ck.level = "ERROR_LEVEL_ERROR" : "WARNING" === ze && (ck.level = "ERROR_LEVEL_WARNNING"); var Fv = { isObfuscated: !0, browserStackInfo: Ae }, qd = { pageUrl: window.location.href, kvPairs: [] }; L("FEXP_EXPERIMENTS") && (qd.experimentIds = L("FEXP_EXPERIMENTS")); var dk = L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS"); if (!Ck() && dk) for (var Ap = p(Object.keys(dk)), yc = Ap.next(); !yc.done; yc = Ap.next()) {
                                                var Bp = yc.value; qd.kvPairs.push({
                                                    key: Bp,
                                                    value: String(dk[Bp])
                                                })
                                            } var ek = H.params; if (ek) { var Cp = p(Object.keys(ek)); for (yc = Cp.next(); !yc.done; yc = Cp.next()) { var Dp = yc.value; qd.kvPairs.push({ key: "client." + Dp, value: String(ek[Dp]) }) } } var Ep = L("SERVER_NAME"), Fp = L("SERVER_VERSION"); Ep && Fp && (qd.kvPairs.push({ key: "server.name", value: Ep }), qd.kvPairs.push({ key: "server.version", value: Fp })); zp = { errorMetadata: qd, stackTrace: Fv, logMessage: ck }
                                        } var Gp = zp; if (!Gp) break a; cm("clientError", Gp)
                                    ...
                                    } else { if (M("web_fp_via_jspb") && (dr(!0), !M("web_fp_via_jspb_and_json"))) break b; dr() }
                                } if (!M("suppress_error_204_logging")) {
                                    var Be = H.params || {}, Zb = { urlParams: { a: "logerror", t: "jserror", type: H.name, msg: H.message.substr(0, 250), line: H.lineNumber, level: h, "client.name": Be.name }, postParams: { url: L("PAGE_NAME", window.location.href), file: H.fileName }, method: "POST" }; Be.version && (Zb["client.version"] = Be.version); if (Zb.postParams) {
                                        H.stack && (Zb.postParams.stack =
                                            H.stack); for (var Hp = p(Object.keys(Be)), fk = Hp.next(); !fk.done; fk = Hp.next()) { var Ip = fk.value; Zb.postParams["client." + Ip] = Be[Ip] } var gk = L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS"); if (gk) for (var Jp = p(Object.keys(gk)), hk = Jp.next(); !hk.done; hk = Jp.next()) { var Kp = hk.value; Zb.postParams[Kp] = gk[Kp] } var Lp = L("SERVER_NAME"), Mp = L("SERVER_VERSION"); Lp && Mp && (Zb.postParams["server.name"] = Lp, Zb.postParams["server.version"] = Mp)
                                    } jl(L("ECATCHER_REPORT_HOST", "") + "/error_204", Zb)
                                } try { Br.add(H.message) } catch (ix) { } Cr++
                            }
            }
        }
    }
    ...
    function Mr(a) { a = p(a.register.values()); for (var b = a.next(); !b.done; b = a.next())b.value.Br("ABORTED") }
    ...
    ; var Qr = z.ytLoggingDocDocumentNonce_; Qr || (Qr = Pr(), A("ytLoggingDocDocumentNonce_", Qr)); var Rr = Qr; var Sr = { bi: 0, we: 1, Ge: 2, Yl: 3, di: 4, zq: 5, Om: 6, Do: 7, Tn: 8, ro: 9, 0: "DEFAULT", 1: "CHAT", 2: "CONVERSATIONS", 3: "MINIPLAYER", 4: "DIALOG", 5: "VOZ", 6: "MUSIC_WATCH_TABS", 7: "SHARE", 8: "PUSH_NOTIFICATIONS", 9: "RICH_GRID_WATCH" }; function Tr(a) { this.G = a }
    ...
    function cs(a, b, c, d) { c = void 0 === c ? 0 : c; if (a !== L(Vr(c)) || b !== L(Wr(c))) if (as(a, d, c), Bk(Vr(c), a), Bk(Wr(c), b), b = function () { setTimeout(function () { if (a) if (M("web_time_via_jspb")) { var e = new uj; D(e, 1, Rr); D(e, 2, a); M("use_default_heartbeat_client") ? or(e) : or(e, void 0, op) } else e = { clientDocumentNonce: Rr, clientScreenNonce: a }, M("use_default_heartbeat_client") ? cm("foregroundHeartbeatScreenAssociated", e) : br("foregroundHeartbeatScreenAssociated", e, op) }, 0) }, "requestAnimationFrame" in window) try { window.requestAnimationFrame(b) } catch (e) { b() } else b() }
    ...
    ; var fs = {
        ue: 3611, Fd: 27686, Gd: 85013, Hd: 23462, Jd: 157557, Kd: 42016, Ld: 62407, Md: 26926, Id: 43781, Nd: 51236, Od: 79148, Pd: 50160, Qd: 77504, ce: 153587, de: 87907, ee: 18630, ge: 54445, he: 80935, ie: 152172, je: 105675, ke: 150723, le: 37521, me: 147285, ne: 47786, oe: 98349, pe: 123695, qe: 6827, re: 29434, se: 7282, te: 124448, ye: 32276, xe: 76278, ze: 147868, Ae: 147869, Be: 93911, Ce: 106531, De: 27259, Ee: 27262, Fe: 27263, He: 21759, Ie: 27107, Je: 62936, Ke: 160866, Le: 49568, Me: 160789, Ne: 38408, Oe: 80637, Pe: 68727, Qe: 68728, Re: 80353, Se: 80356, Te: 74610, Ue: 45707, Ve: 83962,
        ...
        nq: 18635, oq: 39305, pq: 18046, qq: 53969, rq: 8213, sq: 93926, tq: 102852, uq: 110099, wq: 22678, xq: 69076, yq: 137575, Aq: 139224, Bq: 100856, Cq: 154430, Dq: 17736, Eq: 3832, Fq: 147111, Gq: 55759, Hq: 64031, Nq: 93044, Oq: 93045, Pq: 34388, Qq: 17657, Rq: 17655, Sq: 39579, Tq: 39578, Uq: 77448, Vq: 8196, Wq: 11357, Xq: 69877, Yq: 8197, Zq: 156512, br: 161613, dr: 156509, er: 161612, fr: 161614, gr: 82039
    }; function gs() {
        var a = vb(hs), b; return (new yf(function (c, d) {
            a.onSuccess = function (e) { cl(e) ? c(new is(e)) : d(new js("Request failed, status=" + (e && "status" in e ? e.status : -1), "net.badstatus", e)) };
    ...
    ; function ps() { return sg() || Sl && Tl("applewebkit") && !Tl("version") && (!Tl("safari") || Tl("gsa/")) || Nc && Tl("version/") ? !0 : L("EOM_VISITOR_DATA") ? !1 : !0 }
    ...
    function Nk() {
        var a = us(); if (void 0 !== a) return Df(a); ts || (ts = gs().then(vs).ob(function (b) { return ws(2, b) }));
        return ts
    }
    ...
    function xs(a, b) { dl(function () { gs().then(vs, function (c) { return ws(b, c) }).ob(cb) }, a) }
    ...
    function Rs(a, b, c, d) { d = void 0 === d ? !1 : d; if (-1 < c.indexOf(b)) throw Error("Deps cycle for: " + b); if (a.i.has(b)) return a.i.get(b); if (!a.h.has(b)) { if (d) return; throw Error("No provider for: " + b); } d = a.h.get(b); c.push(b); if (d.yc) var e = d.yc; else if (d.Ed) e = d[Ms] ? Ss(a, d[Ms], c) : [], e = d.Ed.apply(d, ia(e)); else if (d.xc) { e = d.xc; var f = e[Ms] ? Ss(a, e[Ms], c) : []; e = new (Function.prototype.bind.apply(e, [null].concat(ia(f)))) } else throw Error("Could not resolve providers for: " + b); c.pop(); d.Gr || a.i.set(b, e); return e }
    ...
    function Ys(a) {
        var b = void 0 === b ? "UNKNOWN_INTERFACE" : b; if (1 === a.length) return a[0]; var c = Xs[b]; if (c) { var d = new RegExp(c), e = p(a); for (c = e.next(); !c.done; c = e.next())if (c = c.value, d.exec(c)) return c } var f = []; Object.entries(Xs).forEach(function (g) { var h = p(g); g = h.next().value; h = h.next().value; b !== g && f.push(h) });
        d = new RegExp(f.join("|")); a.sort(function (g, h) { return g.length - h.length });
        e = p(a); for (c = e.next(); !c.done; c = e.next())if (c = c.value, !d.exec(c)) return c; return a[0]
    }
    ; function Zs() { }
    Zs.prototype.m = function (a, b, c) {
        b = void 0 === b ? {} : b; c = void 0 === c ? Cs : c; var d = a.clickTrackingParams, e = this.l, f = !1; f = void 0 === f ? !1 : f; e = void 0 === e ? !1 : e; var g = L("INNERTUBE_CONTEXT"); if (g) {
            g = wb(g); M("web_no_tracking_params_in_shell_killswitch") || delete g.clickTracking; g.client || (g.client = {}); var h = g.client; "MWEB" === h.clientName && (h.clientFormFactor = L("IS_TABLET") ? "LARGE_FORM_FACTOR" : "SMALL_FORM_FACTOR"); h.screenWidthPoints = window.innerWidth; h.screenHeightPoints = window.innerHeight; h.screenPixelDensity = Math.round(window.devicePixelRatio ||
                1); h.screenDensityFloat = window.devicePixelRatio || 1; h.utcOffsetMinutes = -Math.floor((new Date).getTimezoneOffset()); var k = void 0 === k ? !1 : k; xl.getInstance(); var m = "USER_INTERFACE_THEME_LIGHT"; Al(165) ? m = "USER_INTERFACE_THEME_DARK" : Al(174) ? m = "USER_INTERFACE_THEME_LIGHT" : !M("kevlar_legacy_browsers") && window.matchMedia && window.matchMedia("(prefers-color-scheme)").matches && window.matchMedia("(prefers-color-scheme: dark)").matches && (m = "USER_INTERFACE_THEME_DARK"); k = k ? m : Es() || m; h.userInterfaceTheme = k; if (!f) {
                    if (k =
                        Hl()) h.connectionType = k; M("web_log_effective_connection_type") && (k = Il()) && (g.client.effectiveConnectionType = k)
                    ...
                    rl.h && (r = rl.h, h.mainAppWebInfo.pwaInstallabilityStatus = !r.h && r.i ? "PWA_INSTALLABILITY_STATUS_CAN_BE_INSTALLED" : "PWA_INSTALLABILITY_STATUS_UNKNOWN"), h.mainAppWebInfo.webDisplayMode = sl(), h.mainAppWebInfo.isWebNativeShareAvailable = navigator && void 0 !== navigator.share) : "TVHTML5" === h.clientName && (!M("web_lr_app_quality_killswitch") && (r = L("LIVING_ROOM_APP_QUALITY")) && (h.tvAppInfo = Object.assign(h.tvAppInfo || {}, { appQuality: r })), r = L("LIVING_ROOM_CERTIFICATION_SCOPE")) && (h.tvAppInfo = Object.assign(h.tvAppInfo ||
                        {}, { certificationScope: r })); if (!M("web_populate_time_zone_itc_killswitch")) { b: { if ("undefined" !== typeof Intl) try { var w = (new Intl.DateTimeFormat).resolvedOptions().timeZone; break b } catch (lb) { } w = void 0 } w && (h.timeZone = w) } (w = Fk()) ? h.experimentsToken = w : delete h.experimentsToken; w = Gk(); Fs.h || (Fs.h = new Fs); h = Fs.h.h; r = []; q = 0; for (var t in h) r[q++] = h[t]; g.request = Object.assign({}, g.request, { internalExperimentFlags: w, consistencyTokenJars: r }); !M("web_prequest_context_killswitch") && (t = L("INNERTUBE_CONTEXT_PREQUEST_CONTEXT")) &&
                            (g.request.externalPrequestContext = t); w = xl.getInstance(); t = Al(58); w = w.get("gsml", ""); g.user = Object.assign({}, g.user); t && (g.user.enableSafetyMode = t); w && (g.user.lockedSafetyMode = !0); M("warm_op_csn_cleanup") ? e && (f = $r()) && (g.clientScreenNonce = f) : !f && (f = $r()) && (g.clientScreenNonce = f); d && (g.clickTracking = { clickTrackingParams: d }); if (d = B("yt.mdx.remote.remoteClient_")) g.remoteClient = d; Is.getInstance().setLocationOnInnerTubeContext(g); try {
                                var y = Zk(), E = y.bid; delete y.bid; g.adSignalsInfo = { params: [], bid: E }; var F =
                                    p(Object.entries(y)); for (var O = F.next(); !O.done; O = F.next()) { var N = p(O.value), Q = N.next().value, ca = N.next().value; y = Q; E = ca; d = void 0; null == (d = g.adSignalsInfo.params) || d.push({ key: y, value: "" + E }) }
                            } catch (lb) { Hr(lb) } F = g
        } else Hr(Error("Error: No InnerTubeContext shell provided in ytconfig.")), F = {}; F = { context: F }; if (O = this.h(a)) {
            this.i(F, O, b); var U; b = "/youtubei/v1/" + Ys(this.j()); (O = null == (U = ns(a.commandMetadata, bj)) ? void 0 : U.apiUrl) && (b = O); U = b; (b = L("INNERTUBE_HOST_OVERRIDE")) && (U = String(b) + String(pc(U))); b =
                {}; b.key = L("INNERTUBE_API_KEY"); M("json_condensed_response") && (b.prettyPrint = "false"); U = Xk(U, b || {}, !1); a = Object.assign({}, { command: a }, void 0); a = { input: U, ya: os(U), ha: F, config: a }; a.config.Za ? a.config.Za.identity = c : a.config.Za = { identity: c }; return a
    ...
    $s.prototype.i = function () { }; var at = {}, bt = (at.GET_DATASYNC_IDS = Vs($s), at); function ct(a) {
        var b = Ja.apply(1, arguments); if (!dt(a) || b.some(function (d) { return !dt(d) })) throw Error("Only objects may be merged.");
    ...
    u(ht, co); var jt = new eo("aft-recorded", ht); var kt = window; function lt() {
    ...
    var S = kt.performance || kt.mozPerformance || kt.msPerformance || kt.webkitPerformance || new lt; var mt = !1, nt = {
    ...
    ; function Dt() {
        if (S.getEntriesByType) { var a = S.getEntriesByType("paint"); if (a = kb(a, function (b) { return "first-paint" === b.name })) return rt(a.startTime) } a = S.timing;
    ...
    ; var T = {}, Gt = (T.auto_search = "LATENCY_ACTION_AUTO_SEARCH", T.ad_to_ad = "LATENCY_ACTION_AD_TO_AD", T.ad_to_video = "LATENCY_ACTION_AD_TO_VIDEO", T["analytics.explore"] = "LATENCY_ACTION_CREATOR_ANALYTICS_EXPLORE", T.app_startup = "LATENCY_ACTION_APP_STARTUP", T["artist.analytics"] = "LATENCY_ACTION_CREATOR_ARTIST_ANALYTICS", T["artist.events"] = "LATENCY_ACTION_CREATOR_ARTIST_CONCERTS", T["artist.presskit"] = "LATENCY_ACTION_CREATOR_ARTIST_PROFILE", T["song.analytics"] = "LATENCY_ACTION_CREATOR_SONG_ANALYTICS", T.browse = "LATENCY_ACTION_BROWSE",
        ...
        "LATENCY_ACTION_CREATOR_VIDEO_LIVE_STREAMING", T["video.monetization"] = "LATENCY_ACTION_CREATOR_VIDEO_MONETIZATION", T["video.translations"] = "LATENCY_ACTION_CREATOR_VIDEO_TRANSLATIONS", T.voice_assistant = "LATENCY_ACTION_VOICE_ASSISTANT", T.cast_load_by_entity_to_watch = "LATENCY_ACTION_CAST_LOAD_BY_ENTITY_TO_WATCH", T.networkless_performance = "LATENCY_ACTION_NETWORKLESS_PERFORMANCE", T), V = {}, Ht = (V.ad_allowed = "adTypesAllowed", V.yt_abt = "adBreakType", V.ad_cpn = "adClientPlaybackNonce", V.ad_docid = "adVideoId", V.yt_ad_an =
            ...
            V.GetSettings_rid = "requestIds", V.GetTrending_rid = "requestIds", V.GetMusicSearchSuggestions_rid = "requestIds", V.REQUEST_ID = "requestIds", V), It = "isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized navigationRequestedSameUrl performanceNavigationTiming playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "), Jt = {}, Kt = (Jt.ccs = "CANARY_STATE_",
    ...
    Yt.prototype.tick = function (a, b, c, d) { $t(this, "tick_" + a + "_" + b) || (c = { timestamp: c, cttAuthInfo: d }, M("web_csi_via_jspb") ? (d = new Mj, D(d, 1, a), D(d, 2, b), a = new jk, Zd(a, Mj, 5, kk, d), hr(a, c)) : cm("latencyActionTicked", { tickName: a, clientActionNonce: b }, c)) };
    ...
    Yt.prototype.jspbInfo = function (a, b, c) { for (var d = "", e = 0; e < a.toJSON().length; e++)void 0 !== a.toJSON()[e] && (d = 0 === e ? d.concat("" + e) : d.concat("_" + e)); $t(this, "info_" + d + "_" + b) || (D(a, 2, b), b = { cttAuthInfo: c }, c = new jk, Zd(c, Ij, 7, kk, a), hr(c, b)) };
    ...
    function $t(a, b) {
        Xt[b] = Xt[b] || { count: 0 }; var c = Xt[b]; c.count++; c.time = R(); a.h || (a.h = Kl(function () { var d = R(), e; for (e in Xt) Xt[e] && 6E4 < d - Xt[e].time && delete Xt[e]; a && (a.h = 0) }, 5E3));
    ...
    ; function au() {
        var a = ["ol"]; Ft("").info.actionType = "embed"; a && Bk("TIMING_AFT_KEYS", a); Bk("TIMING_ACTION", "embed"); if (M("web_csi_via_jspb")) {
            a = L("TIMING_INFO", {}); var b = new Ij; a = p(Object.entries(a)); for (var c = a.next(); !c.done; c = a.next()) {
                var d = p(c.value); c = d.next().value; d = d.next().value; switch (c) {
                    case "GetBrowse_rid": var e = new Lj; D(e, 1, c); D(e, 2, String(d)); Kj(b, e); break; case "GetGuide_rid": e = new Lj; D(e, 1, c); D(e, 2, String(d)); Kj(b, e); break; case "GetHome_rid": e = new Lj; D(e, 1, c); D(e, 2, String(d)); Kj(b, e);
            ...
            } bu(b); b = new Ij; b = D(b, 25, !0); b = D(b, 1, W[Mt(L("TIMING_ACTION"))]); (a = L("PREVIOUS_ACTION")) &&
                D(b, 13, W[Mt(a)]); (a = L("CLIENT_PROTOCOL")) && D(b, 33, a); (a = L("CLIENT_TRANSPORT")) && D(b, 34, a); (a = $r()) && "UNDEFINED_CSN" !== a && D(b, 4, a); a = cu(); 1 !== a && -1 !== a || D(b, 6, !0); a = ut(); D(b, 3, "cold"); du(a); a = eu(); if (0 < a.length) for (a = p(a), c = a.next(); !c.done; c = a.next())c = c.value, d = new Hj, D(d, 1, c), ae(b, 83, Hj, d); bu(b)
        } else {
            a = L("TIMING_INFO", {}); for (b in a) a.hasOwnProperty(b) && fu(b, a[b]); b = { isNavigation: !0, actionType: Mt(L("TIMING_ACTION")) }; if (a = L("PREVIOUS_ACTION")) b.previousAction = Mt(a); if (a = L("CLIENT_PROTOCOL")) b.httpProtocol =
                a; if (a = L("CLIENT_TRANSPORT")) b.transportProtocol = a; (a = $r()) && "UNDEFINED_CSN" !== a && (b.clientScreenNonce = a); a = cu(); if (1 === a || -1 === a) b.isVisible = !0; ut(); b.loadType = "cold"; du(ut()); a = eu(); if (0 < a.length) for (b.resourceInfo = [], a = p(a), c = a.next(); !c.done; c = a.next())b.resourceInfo.push({ resourceCache: c.value }); gu(b)
        } b = ut(); a = zt(); if (!(M("skip_setting_info_in_csi_data_object") && "cold" !== vt().loadType || "cold" !== b.yt_lt && "cold" !== a.loadType)) {
            c = wt(); d = xt(); d = d.gelTicks ? d.gelTicks : d.gelTicks = {}; for (var f in c) if (!(f in
                d)) if ("number" === typeof c[f]) Z(f, pt(f)); else if (M("log_repeated_ytcsi_ticks")) { e = p(c[f]); for (var g = e.next(); !g.done; g = e.next())Z(f.slice(1), g.value) } f = {}; c = !1; d = p(Object.keys(b)); for (e = d.next(); !e.done; e = d.next())e = e.value, (e = Nt(e, b[e])) && !Ct(zt(), e) && (ct(a, e), ct(f, e), c = !0); c && gu(f)
        } A("ytglobal.timingready_", !0); f = L("TIMING_ACTION"); B("ytglobal.timingready_") && f && "_start" in wt() && ot() && Bt()
    }
    ...
    function gu(a, b, c) {
        if (!M("web_csi_via_jspb") || (void 0 === c ? 0 : c)) c = Ft(b || ""), ct(c.info, a), M("skip_setting_info_in_csi_data_object") && a.loadType && (c = a.loadType, vt(b).loadType = c), ct(zt(b), a), c = At(b), b = tt(b).cttAuthInfo, Zt().info(a, c, b); else {
            c = new Ij; var d = Object.keys(a); a = Object.values(a); for (var e = 0; e < d.length; e++) {
                var f = d[e]; try {
                    switch (f) {
                        ...
                        case "getSearchRequestId": D(c, 60, a[e]); break; case "getPlayerRequestId": D(c, 61, a[e]); break; case "getWatchNextRequestId": D(c, 62, a[e]); break; case "getBrowseRequestId": D(c, 63, a[e]); break; case "getLibraryRequestId": D(c, 66, a[e]); break; default: Wt.includes(f) && Kk(new P("Codegen laipb translator asked to translate message field", "" + f))
                    }
                } catch (g) { Kk(Error("Codegen laipb translator failed to set " + f)) }
            } bu(c, b)
        }
    }
    function bu(a, b) { if (M("skip_setting_info_in_csi_data_object")) { var c = ce(Rd(a, 3), ""); c && (vt(b).loadType = c) } else c = xt(b), c.jspbInfos || (c.jspbInfos = []), c.jspbInfos.push(ie(a)); Ft(b || "").jspbInfo.push(a); c = At(b); b = tt(b).cttAuthInfo; Zt().jspbInfo(a, c, b) }
    function Z(a, b, c) {
        if (!b && "_" !== a[0]) { var d = a; S.mark && (0 == d.lastIndexOf("mark_", 0) || (d = "mark_" + d), c && (d += " (" + c + ")"), S.mark(d)) } d = Ft(c || ""); d.tick[a] = b || R(); if (d.callback && d.callback[a]) { d = p(d.callback[a]); for (var e = d.next(); !e.done; e = d.next())e = e.value, e() } d = xt(c); d.gelTicks && (d.gelTicks[a] = !0); e = wt(c); d = b || R(); M("log_repeated_ytcsi_ticks") ? a in e || (e[a] = d) : e[a] = d; e = At(c); var f = tt(c).cttAuthInfo; "_start" === a ? (a = Zt(), $t(a, "baseline_" + e) || (b = { timestamp: b, cttAuthInfo: f }, M("web_csi_via_jspb") ? (a = new Gj,
            D(a, 1, e), e = new jk, Zd(e, Gj, 6, kk, a), hr(e, b)) : cm("latencyActionBaselined", { clientActionNonce: e }, b))) : Zt().tick(a, e, b, f); Bt(c); return d
    }
    ...
    function ou(a, b, c, d) {
        if (void 0 !== nu.h) {
            if (d = nu.h, a = [a !== d.m, b !== d.L, c !== d.l, !1, !1, void 0 !== d.i], a.some(function (e) { return e })) throw new P("InnerTubeTransportService is already initialized", a);
        } else nu.h = new nu(a, b, c, d)
    }
    function pu(a) {
        var b = { signalServiceEndpoint: { signal: "GET_DATASYNC_IDS" } }; var c = void 0 === c ? Cs : c; var d = Ls(b, a.m); if (!d) return Df(new P("Error: No request builder found for command.", b)); var e = d.m(b, void 0, c); return e ? new yf(function (f) {
            var g, h, k; return x(function (m) {
                if (1 == m.h) {
                    h = "cors" === (null == (g = e.ya) ? void 0 : g.mode) ? "cors" : void 0; if (a.l.yd) { var q = e.config, r; q = null == q ? void 0 : null == (r = q.Za) ? void 0 : r.sessionIndex; r = Bs({ sessionIndex: q }); k = Object.assign({}, qu(h), r); return m.A(2) } return v(m, ru(e.config,
                        h), 3)
                } 2 != m.h && (k = m.i); f(su(a, e, k)); m.h = 0
            })
        }) : Df(new P("Error: Failed to build request for command.", b))
    }
    function tu(a, b, c) { var d; if (b && !(null == b ? 0 : null == (d = b.Er) ? 0 : d.Hr) && a.j) { d = p(lu); for (var e = d.next(); !e.done; e = d.next())e = e.value, a.j[e] && a.j[e].handleResponse(b, c) } }
    function su(a, b, c) {
        var d, e, f, g, h, k, m, q, r, w, t, y, E, F, O, N, Q, ca, U, lb, Wa, na, H, la, fa, xe, ye, nd; return x(function (pa) {
            switch (pa.h) {
                case 1: pa.A(2); break; case 3: if ((d = pa.i) && !d.isExpired()) return pa.return(Promise.resolve(d.h())); case 2: if (null == (e = b) ? 0 : null == (f = e.ha) ? 0 : f.context) for (g = p([]), h = g.next(); !h.done; h = g.next())k = h.value, k.Ar(b.ha.context); if (null == (m = a.i) || !m.Fr(b.input, b.ha)) { pa.A(4); break } return v(pa, a.i.vr(b.input, b.ha), 5); case 5: return q = pa.i, M("kevlar_process_local_innertube_responses_killswitch") ||
                ...
                case 6: U = pa.i; if (M("web_one_platform_error_handling") && U && "error" in U && (null == (lb = U) ? 0 : null == (Wa = lb.error) ? 0 : Wa.details)) for (na = U.error.details, H = p(na), la = H.next(); !la.done; la = H.next())fa = la.value, (xe = fa["@type"]) && -1 < mu.indexOf(xe) && (delete fa["@type"], U = fa); t && a.h.has(t) && a.h.delete(t); (null == (ye = b.config) ? 0 : ye.md) && Z(b.config.md); if (U || null == (nd = a.i) || !nd.lr(b.input, b.ha)) { pa.A(7); break } return v(pa, a.i.ur(b.input, b.ha), 8); case 8: U = pa.i; case 7: return tu(a, U, b), pa.return(U || void 0)
            }
        })
    }
    ...
    Hu.prototype.handleResponse = function (a) {
        ...
        a.redirected || a.ok ? this.h && this.h.success() : (this.h && this.h.rr(), b = b.then(function (c) { Ir(new P("Error: API fetch failed", a.status, a.url, c)); return Object.assign({}, c, { errorMetadata: { status: a.status } }) }));
        return b
    };
    Hu[Ms] = [new Os]; var Iu = new Ns("NETWORK_MANAGER_TOKEN"); var Ju; function Ku(a) { co.call(this, 1, arguments); this.csn = a }
    u(Ku, co); var mo = new eo("screen-created", Ku), Lu = [], Nu = Mu, Ou = 0; function Pu(a, b, c, d, e, f, g) {
        function h() { Ir(new P("newScreen() parent element does not have a VE - rootVe", b)) }
    ...
    function Qu(a, b, c, d) {
        var e = d.filter(function (k) { k.csn !== b ? (k.csn = b, k = !0) : k = !1; return k }), f = {
            ...
            aa: b
        }; d = p(d); for (var g = d.next(); !g.done; g = d.next())g = g.value.getAsJson(), (rb(g) || !g.trackingParams && !g.veType) && Ir(Error("Child VE logged with no data")); if (M("il_via_jspb")) {
            var h = new zj; h.i(b); Bj(h, c.getAsJspb()); hb(e, function (k) { k = k.getAsJspb(); ae(h, 3, tj, k) });
            "UNDEFINED_CSN" === b ? Ru("visualElementAttached", f, void 0, h) : nr(h, f, a)
        } else c = { csn: b, parentVe: c.getAsJson(), childVes: hb(e, function (k) { return k.getAsJson() }) }, "UNDEFINED_CSN" === b ? Ru("visualElementAttached", f, c) : a ? br("visualElementAttached", c, a, f) : cm("visualElementAttached", c, f)
    }
    function Mu() { for (var a = Math.random() + "", b = [], c = 0, d = 0; d < a.length; d++) { var e = a.charCodeAt(d); 255 < e && (b[c++] = e & 255, e >>= 8); b[c++] = e } return bd(b, 3) }
    function Ru(a, b, c, d) { Lu.push({ Eb: a, payload: c, na: d, options: b }); Ou || (Ou = no()) }
    function oo(a) {
        if (Lu) {
            for (var b = p(Lu), c = b.next(); !c.done; c = b.next())if (c = c.value, M("il_via_jspb") && c.na) switch (c.na.i(a.csn), c.Eb) { case "screenCreated": mr(c.na, c.options); break; case "visualElementAttached": nr(c.na, c.options); break; case "visualElementShown": ir(c.na, c.options); break; case "visualElementHidden": jr(c.na, c.options); break; case "visualElementGestured": kr(c.na, c.options); break; case "visualElementStateChanged": lr(c.na, c.options); break; default: Ir(new P("flushQueue unable to map payloadName to JSPB setter")) } else c.payload &&
                (c.payload.csn = a.csn, br(c.Eb, c.payload, null, c.options)); Lu.length = 0
        } Ou = 0
    }
    ; function Su() { this.j = new Set; this.h = new Set; this.l = new Map; this.client = op; this.csn = null }
    ...
    Vu.prototype.clickCommand = function (a, b, c) {
        var d = a.clickTrackingParams; c = void 0 === c ? 0 : c; if (d) if (c = $r(void 0 === c ? 0 : c)) {
            a = this.client; var e = Ur(d); d = { cttAuthInfo: bs(c) || void 0, aa: c }; M("il_via_jspb") ? (b = new Cj, b.i(c), e = e.getAsJspb(), G(b, tj, 2, e), D(b, 4, lk.INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK), "UNDEFINED_CSN" === c ? Ru("visualElementGestured", d, void 0, b) : kr(b, d, a)) : (e = { csn: c, ve: e.getAsJson(), gestureType: "INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK" }, b && (e.clientData = b), "UNDEFINED_CSN" === c ? Ru("visualElementGestured",
                d, e) : a ? br("visualElementGestured", e, a, d) : cm("visualElementGestured", e, d)); b = !0
        } else b = !1; else b = !1; return b
    };
    function Yu(a, b, c) {
        c = void 0 === c ? {} : c; a.j.add(c.layer || 0); a.l = function () {
            Zu(a, b, c); var f = Yr(c.layer); if (f) {
                for (var g = p(a.o), h = g.next(); !h.done; h = g.next())h = h.value, Xu(a, h[0], h[1] || f, c.layer); f = p(a.M); for (g = f.next(); !g.done; g = f.next()) {
                    var k = g.value; g = void 0; g = void 0 === g ? 0 : g; h = $r(g); var m = k[0] || Yr(g); if (h && m) {
                        g = a.client; var q = k[1]; k = { cttAuthInfo: bs(h) || void 0, aa: h }; M("il_via_jspb") ? (q = new Fj, q.i(h), m = m.getAsJspb(), G(q, tj, 2, m), "UNDEFINED_CSN" === h ? Ru("visualElementStateChanged", k, void 0, q) : lr(q, k, g)) :
    ...
    function wv(a, b, c, d) {
        d = void 0 === d ? null : d; var e = lf("SCRIPT"); e.id = b; e.onload = function () { c && setTimeout(c, 0) };
    ...
    var vv = {}; var zv = [], Av = !1; function Bv() {
        if (!M("disable_biscotti_fetch_for_ad_blocker_detection") && !M("disable_biscotti_fetch_entirely_for_all_web_clients") && ps()) {
            var a = L("PLAYER_VARS", {}); if ("1" != tb(a) && !qs(a)) {
                var b = function () { Av = !0; "google_ad_status" in window ? Bk("DCLKSTAT", 1) : Bk("DCLKSTAT", 2) };
    ...
    l.Ib = function (a) { qe(this.h); this.h = a }; function Iv() { var a = B("yt.abuse.playerAttLoader"); return a && ["bgvma", "bgvmb", "bgvmc"].every(function (b) { return b in a }) ? a : null }
    ; function Jv() { Dv.apply(this, arguments) }
    u(Jv, Dv); Jv.prototype.Mb = function () { this.state = 8 };
    Jv.prototype.Ib = function (a) { var b; null == (b = Iv()) || b.bgvma(); a ? (b = { bgvma: a.dispose.bind(a), bgvmb: a.snapshot.bind(a), bgvmc: a.uc.bind(a) }, A("yt.abuse.playerAttLoader", b), A("yt.abuse.playerAttLoaderRun", function (c) { return a.snapshot(c) })) : (A("yt.abuse.playerAttLoader", null), A("yt.abuse.playerAttLoaderRun", null)) };
    Jv.prototype.Kb = function () { return !!Iv() };
    Jv.prototype.zc = function (a) { return Iv().bgvmc(a) }; var Kv = new Jv; function Lv() { return Kv.Kb() }
    function Mv(a) { a = void 0 === a ? {} : a; a = void 0 === a ? {} : a; return Kv.invoke(a) }
    ; function Nv(a) {
        var b = this; var c = void 0 === c ? 0 : c; var d = void 0 === d ? Pl() : d; this.l = c; this.j = d; this.i = new Bh; this.h = a; a = {}; c = p(this.h.entries()); for (d = c.next(); !d.done; a = { Ga: a.Ga, Ra: a.Ra }, d = c.next()) {
            var e = p(d.value); d = e.next().value; e = e.next().value; a.Ra = d; a.Ga = e; d = function (f) { return function () { f.Ga.Ab(); b.h[f.Ra].lb = !0; b.h.every(function (g) { return !0 === g.lb }) && b.i.resolve() } }(a);
            e = Ll(d, Ov(this, a.Ga)); this.h[a.Ra] = Object.assign({}, a.Ga, { Ab: d, jobId: e })
        }
    }
    function Pv(a) {
        var b = Array.from(a.h.keys()).sort(function (d, e) { return Ov(a, a.h[e]) - Ov(a, a.h[d]) });
        b = p(b); for (var c = b.next(); !c.done; c = b.next())c = a.h[c.value], void 0 === c.jobId || c.lb || (a.j.fa(c.jobId), Ll(c.Ab, 10))
    }
    Nv.prototype.cancel = function () { for (var a = p(this.h), b = a.next(); !b.done; b = a.next())b = b.value, void 0 === b.jobId || b.lb || this.j.fa(b.jobId), b.lb = !0; this.i.resolve() };
    function Ov(a, b) { var c; return null != (c = b.priority) ? c : a.l }
    ; function Qv(a) { this.state = a; this.plugins = []; this.o = void 0 }
    Qv.prototype.install = function () { this.plugins.push.apply(this.plugins, ia(Ja.apply(0, arguments))) };
    Qv.prototype.uninstall = function () { var a = this; Ja.apply(0, arguments).forEach(function (b) { b = a.plugins.indexOf(b); -1 < b && a.plugins.splice(b, 1) }) };
    Qv.prototype.transition = function (a, b) {
        var c = this, d = this.B.find(function (f) { return Array.isArray(f.from) ? f.from.find(function (g) { return g === c.state && f.D === a }) : f.from === c.state && f.D === a });
        if (d) {
            this.j && (Pv(this.j), this.j = void 0); this.state = a; d = d.action.bind(this); var e = this.plugins.filter(function (f) { return f[a] }).map(function (f) { return f[a] });
    ...
    u(Sv, Qv); Sv.prototype.M = function (a, b) { if (!this.h.get("document_disposed_preventable")) { a(null == b ? void 0 : b.event); var c, d; if ((null == b ? 0 : null == (c = b.event) ? 0 : c.defaultPrevented) || (null == b ? 0 : null == (d = b.event) ? 0 : d.returnValue)) { b.event.returnValue || (b.event.returnValue = !0); b.event.defaultPrevented || b.event.preventDefault(); this.h = new Map; this.transition("document_active"); return } } this.h.set("document_disposed_preventable", !0); this.h.get("document_disposed") ? this.transition("flush_logs") : this.transition("document_disposed") };
    Sv.prototype.l = function (a, b) { this.h.get("document_disposed") ? this.transition("document_active") : (a(null == b ? void 0 : b.event), this.h.set("document_disposed", !0), this.transition("flush_logs")) };
    Sv.prototype.m = function (a, b) { a(null == b ? void 0 : b.event); this.transition("document_active") };
    Sv.prototype.i = function () { this.h = new Map }; function Tv(a) {
        Qv.call(this, void 0 === a ? "document_visibility_unknown" : a); var b = this; this.B = [{ from: "document_visibility_unknown", D: "document_visible", action: this.i }, { from: "document_visibility_unknown", D: "document_hidden", action: this.h }, { from: "document_visibility_unknown", D: "document_foregrounded", action: this.m }, { from: "document_visibility_unknown", D: "document_backgrounded", action: this.l }, { from: "document_visible", D: "document_hidden", action: this.h }, { from: "document_visible", D: "document_foregrounded", action: this.m },
    ...
    u(Tv, Qv); Tv.prototype.i = function (a, b) { a(null == b ? void 0 : b.event); M("visibility_lifecycles_dynamic_backgrounding") && this.transition("document_foregrounded") };
    Tv.prototype.h = function (a, b) { a(null == b ? void 0 : b.event); M("visibility_lifecycles_dynamic_backgrounding") && this.transition("document_backgrounded") };
    Tv.prototype.l = function (a, b) { a(null == b ? void 0 : b.event) };
    Tv.prototype.m = function (a, b) { a(null == b ? void 0 : b.event) }; function Uv() { this.h = new Sv; this.i = new Tv }
    Uv.prototype.install = function () { var a = Ja.apply(0, arguments); this.h.install.apply(this.h, ia(a)); this.i.install.apply(this.i, ia(a)) }; function Vv() { Uv.call(this); var a = {}; this.install((a.document_disposed = { callback: this.j }, a)); a = {}; this.install((a.flush_logs = { callback: this.l }, a)) }
    var Wv; u(Vv, Uv); Vv.prototype.l = function () { if (M("web_fp_via_jspb")) { var a = new sj, b = $r(); b && D(a, 1, b); b = new jk; Zd(b, sj, 380, kk, a); hr(b); M("web_fp_via_jspb_and_json") && cm("finalPayload", { csn: $r() }) } else cm("finalPayload", { csn: $r() }) };
    Vv.prototype.j = function () { Mr(Nr) }; function Xv() { }
    Xv.getInstance = function () { var a = B("ytglobal.storage_"); a || (a = new Xv, A("ytglobal.storage_", a)); return a };
    Xv.prototype.estimate = function () { var a, b, c; return x(function (d) { a = navigator; return (null == (b = a.storage) ? 0 : b.estimate) ? d.return(a.storage.estimate()) : (null == (c = a.webkitTemporaryStorage) ? 0 : c.queryUsageAndQuota) ? d.return(Yv()) : d.return() }) };
    ...
    A("ytglobal.storageClass_", Xv); function am(a, b) {
    ...
    function Zv(a, b) { Xv.getInstance().estimate().then(function (c) { c = Object.assign({}, b, { isSw: void 0 === self.document, isIframe: self !== self.top, deviceStorageUsageMbytes: $v(null == c ? void 0 : c.usage), deviceStorageQuotaMbytes: $v(null == c ? void 0 : c.quota) }); a.h("idbQuotaExceeded", c) }) }
    function $v(a) { return "undefined" === typeof a ? "-1" : String(Math.ceil(a / 1048576)) }
    ; function aw(a, b, c) {
    ...
    u(aw, J); aw.prototype.sendMessage = function (a, b) { if (b = b || this.l) { this.sessionId && (a.id = this.sessionId); this.i && (a.channel = this.i); try { var c = JSON.stringify(a); b.postMessage(c, this.targetOrigin) } catch (d) { Lk(d) } } };
    aw.prototype.C = function () { window.removeEventListener("message", this.F); J.prototype.C.call(this) }; function bw() { this.i = []; this.isReady = !1; this.j = {}; var a = this.h = new aw(!!L("WIDGET_ID_ENFORCE")), b = this.hd.bind(this); a.o = b; a.s = null; this.h.i = "widget"; if (a = L("WIDGET_ID")) this.h.sessionId = a }
    l = bw.prototype; l.hd = function (a, b, c) { "addEventListener" === a && b ? (a = b[0], this.j[a] || "onReady" === a || (this.addEventListener(a, cw(this, a)), this.j[a] = !0)) : this.Nb(a, b, c) };
    l.Nb = function () { };
    function cw(a, b) { return function (c) { return a.sendMessage(b, c) } }
    ...
    function jw(a, b, c, d) { if (Qa(a) && !Array.isArray(a)) { b = "playlist list listType index startSeconds suggestedQuality".split(" "); c = {}; for (d = 0; d < b.length; d++) { var e = b[d]; a[e] && (c[e] = a[e]) } return c } b = { index: b, startSeconds: c, suggestedQuality: d }; "string" === typeof a && 16 === a.length ? b.list = "PL" + a : b.playlist = a; return b }
    ; function kw(a) {
        bw.call(this); this.listeners = []; this.api = a; this.addEventListener("onReady", this.onReady.bind(this)); this.addEventListener("onVideoProgress", this.sd.bind(this)); this.addEventListener("onVolumeChange", this.td.bind(this)); this.addEventListener("onApiChange", this.nd.bind(this)); this.addEventListener("onPlaybackQualityChange", this.pd.bind(this)); this.addEventListener("onPlaybackRateChange", this.qd.bind(this)); this.addEventListener("onStateChange", this.rd.bind(this)); this.addEventListener("onWebglSettingsChanged",
            this.ud.bind(this))
    }
    u(kw, bw); l = kw.prototype;
    l.Nb = function (a, b, c) {
        if (this.api.isExternalMethodAvailable(a, c)) {
            b = b || []; if (0 < b.length && hw(a)) {
                var d = b; if (Qa(d[0]) && !Array.isArray(d[0])) var e = d[0]; else switch (e = {}, a) {
                    case "loadVideoById": case "cueVideoById": e = iw(d[0], void 0 !== d[1] ? Number(d[1]) : void 0, d[2]); break; case "loadVideoByUrl": case "cueVideoByUrl": e = d[0]; "string" === typeof e && (e = { mediaContentUrl: e, startSeconds: void 0 !== d[1] ? Number(d[1]) : void 0, suggestedQuality: d[2] }); b: {
                        if ((d = e.mediaContentUrl) && (d = /\/([ve]|embed)\/([^#?]+)/.exec(d)) && d[2]) {
                            d =
                            d[2]; break b
                        } d = null
                    } e.videoId = d; e = iw(e); break; case "loadPlaylist": case "cuePlaylist": e = jw(d[0], d[1], d[2], d[3])
                }b.length = 1; b[0] = e
            } this.api.handleExternalCall(a, b, c); hw(a) && dw(this, this.wb())
        }
    };
    l.onReady = function () { var a = this.Sc.bind(this); this.h.j = a; a = this.api.getVideoData(); if (!a.isPlayable) { a = a.errorCode; var b = void 0 === b ? 5 : b; this.sendMessage("onError", (a ? fw[a] || b : b).toString()) } };
    ...
    l.pd = function (a) { dw(this, { playbackQuality: a }) };
    l.qd = function (a) { dw(this, { playbackRate: a }) };
    ...
    l.td = function () { dw(this, { muted: this.api.isMuted(), volume: this.api.getVolume() }) };
    ...
    l.ud = function () { var a = { sphericalProperties: this.api.getSphericalProperties() }; dw(this, a) };
    l.dispose = function () { bw.prototype.dispose.call(this); for (var a = 0; a < this.listeners.length; a++) { var b = this.listeners[a]; this.api.removeEventListener(b.eventType, b.listener) } this.listeners = [] }; function lw(a) { J.call(this); this.i = {}; this.started = !1; this.connection = a; this.connection.subscribe("command", this.mc, this) }
    u(lw, J); l = lw.prototype; l.start = function () { this.started || this.h() || (this.started = !0, this.connection.za("RECEIVING")) };
    l.za = function (a, b) { this.started && !this.h() && this.connection.za(a, b) };
    l.mc = function (a, b, c) { if (this.started && !this.h()) { var d = b || {}; switch (a) { case "addEventListener": "string" === typeof d.event && this.addListener(d.event); break; case "removeEventListener": "string" === typeof d.event && this.removeListener(d.event); break; default: this.api.isReady() && this.api.isExternalMethodAvailable(a, c || null) && (b = mw(a, b || {}), c = this.api.handleExternalCall(a, b, c || null), (c = nw(a, c)) && this.za(a, c)) } } };
    ...
    l.C = function () { var a = this.connection; a.h() || ti(a.i, "command", this.mc, this); this.connection = null; for (var b in this.i) this.i.hasOwnProperty(b) && this.removeListener(b); J.prototype.C.call(this) }; function ow(a, b) { lw.call(this, b); this.api = a; this.start() }
    ...
    function mw(a, b) {
        switch (a) {
            case "loadVideoById": return a = iw(b), [a]; case "cueVideoById": return a = iw(b), [a]; case "loadVideoByPlayerVars": return [b]; case "cueVideoByPlayerVars": return [b]; case "loadPlaylist": return a = jw(b), [a]; case "cuePlaylist": return a = jw(b), [a]; case "seekTo": return [b.seconds, b.allowSeekAhead]; case "playVideoAt": return [b.index]; case "setVolume": return [b.volume]; case "setPlaybackQuality": return [b.suggestedQuality]; case "setPlaybackRate": return [b.suggestedRate]; case "setLoop": return [b.loopPlaylists];
    ...
    ow.prototype.C = function () { lw.prototype.C.call(this); delete this.api }; function pw(a) { a = void 0 === a ? !1 : a; J.call(this); this.i = new K(a); se(this, this.i) }
    Za(pw, J); pw.prototype.subscribe = function (a, b, c) { return this.h() ? 0 : this.i.subscribe(a, b, c) };
    pw.prototype.m = function (a, b) { this.h() || this.i.ta.apply(this.i, arguments) }; function qw(a, b, c) { pw.call(this); this.l = a; this.j = b; this.id = c }
    u(qw, pw); qw.prototype.za = function (a, b) { this.h() || this.l.za(this.j, this.id, a, b) };
    qw.prototype.C = function () { this.j = this.l = null; pw.prototype.C.call(this) }; function rw(a, b, c) { J.call(this); this.i = a; this.origin = c; this.j = Vp(window, "message", this.l.bind(this)); this.connection = new qw(this, a, b); se(this, this.connection) }
    u(rw, J); rw.prototype.za = function (a, b, c, d) { this.h() || a !== this.i || (a = { id: b, command: c }, d && (a.data = d), this.i.postMessage(JSON.stringify(a), this.origin)) };
    ...
    rw.prototype.C = function () { Wp(this.j); this.i = null; J.prototype.C.call(this) }; function sw(a) { a = a || {}; var b = {}, c = {}; this.url = a.url || ""; this.args = a.args || vb(b); this.assets = a.assets || {}; this.attrs = a.attrs || vb(c); this.fallback = a.fallback || null; this.fallbackMessage = a.fallbackMessage || null; this.html5 = !!a.html5; this.disable = a.disable || {}; this.loaded = !!a.loaded; this.messages = a.messages || {} }
    sw.prototype.clone = function () { var a = new sw, b; for (b in this) if (this.hasOwnProperty(b)) { var c = this[b]; "object" == Oa(c) ? a[b] = vb(c) : a[b] = c } return a }; var tw = /cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/; function uw(a) { a = a || ""; if (window.spf) { var b = a.match(tw); spf.style.load(a, b ? b[1] : "", void 0) } else vw(a) }
    function vw(a) { var b = ww(a), c = document.getElementById(b), d = c && ov(c, "loaded"); d || c && !d || (c = xw(a, b, function () { ov(c, "loaded") || (mv(c), kq(b), dl(Ya(lq, b), 0)) })) }
    function xw(a, b, c) {
    ...
    function ww(a) { var b = lf("A"); Db("This URL is never added to the DOM"); fc(b, new Ob(a, Pb)); a = b.href.replace(/^[a-zA-Z]+:\/\//, "//"); return "css-" + kc(a) }
    ; function yw() { J.call(this); this.i = [] }
    u(yw, J); yw.prototype.C = function () { for (; this.i.length;) { var a = this.i.pop(); a.target.removeEventListener(a.name, a.callback, void 0) } J.prototype.C.call(this) }; function zw() { yw.apply(this, arguments) }
    u(zw, yw); function Aw(a, b, c, d, e) { J.call(this); var f = this; this.s = b; this.webPlayerContextConfig = d; this.Wa = e; this.da = !1; this.api = {}; this.W = this.o = null; this.K = new K; this.i = {}; this.P = this.X = this.elementId = this.va = this.config = null; this.O = !1; this.l = this.F = null; this.ka = {}; this.Xa = ["onReady"]; this.lastError = null; this.Ia = NaN; this.I = {}; this.Ya = new zw(this); this.S = 0; this.j = this.m = a; se(this, this.K); Bw(this); Cw(this); se(this, this.Ya); c ? this.S = dl(function () { f.loadNewVideoConfig(c) }, 0) : d && (Dw(this), Ew(this)) }
    u(Aw, J); l = Aw.prototype; l.getId = function () { return this.s };
    l.loadNewVideoConfig = function (a) { if (!this.h()) { this.S && (window.clearTimeout(this.S), this.S = 0); var b = a || {}; b instanceof sw || (b = new sw(b)); this.config = b; this.setConfig(a); Ew(this); this.isReady() && Fw(this) } };
    function Dw(a) { var b; a.webPlayerContextConfig ? b = a.webPlayerContextConfig.rootElementId : b = a.config.attrs.id; a.elementId = b || a.elementId; "video-player" === a.elementId && (a.elementId = a.s, a.webPlayerContextConfig ? a.webPlayerContextConfig.rootElementId = a.s : a.config.attrs.id = a.s); var c; (null == (c = a.j) ? void 0 : c.id) === a.elementId && (a.elementId += "-player", a.webPlayerContextConfig ? a.webPlayerContextConfig.rootElementId = a.elementId : a.config.attrs.id = a.elementId) }
    l.setConfig = function (a) { this.va = a; this.config = Gw(a); Dw(this); if (!this.X) { var b; this.X = Hw(this, (null == (b = this.config.args) ? void 0 : b.jsapicallback) || "onYouTubePlayerReady") } this.config.args ? this.config.args.jsapicallback = null : this.config.args = { jsapicallback: null }; var c; if (null == (c = this.config) ? 0 : c.attrs) a = this.config.attrs, (b = a.width) && this.j && (this.j.style.width = Qh(Number(b) || b)), (a = a.height) && this.j && (this.j.style.height = Qh(Number(a) || a)) };
    function Fw(a) { if (a.config && !0 !== a.config.loaded) if (a.config.loaded = !0, !a.config.args || "0" !== a.config.args.autoplay && 0 !== a.config.args.autoplay && !1 !== a.config.args.autoplay) { var b; a.api.loadVideoByPlayerVars(null != (b = a.config.args) ? b : null) } else a.api.cueVideoByPlayerVars(a.config.args) }
    function Iw(a) { var b = !0, c = Jw(a); c && a.config && (a = Kw(a), b = ov(c, "version") === a); return b && !!B("yt.player.Application.create") }
    function Ew(a) {
        if (!a.h() && !a.O) {
            var b = Iw(a); if (b && "html5" === (Jw(a) ? "html5" : null)) a.P = "html5", a.isReady() || Lw(a); else if (Mw(a), a.P = "html5", b && a.l && a.m) a.m.appendChild(a.l), Lw(a); else {
                a.config && (a.config.loaded = !0); var c = !1; a.F = function () { c = !0; var d = Nw(a, "player_bootstrap_method") ? B("yt.player.Application.createAlternate") || B("yt.player.Application.create") : B("yt.player.Application.create"); var e = a.config ? Gw(a.config) : void 0; d && d(a.m, e, a.webPlayerContextConfig, a.Wa); Lw(a) };
                a.O = !0; b ? a.F() : (sv(Kw(a), a.F), (b = Ow(a)) && uw(b), Pw(a) && !c && A("yt.player.Application.create", null))
            }
        }
    }
    function Jw(a) { var b = kf(a.elementId); !b && a.j && a.j.querySelector && (b = a.j.querySelector("#" + a.elementId)); return b }
    function Lw(a) { if (!a.h()) { var b = Jw(a), c = !1; b && b.getApiInterface && b.getApiInterface() && (c = !0); if (c) { a.O = !1; if (!Nw(a, "html5_remove_not_servable_check_killswitch")) { var d; if ((null == b ? 0 : b.isNotServable) && a.config && (null == b ? 0 : b.isNotServable(null == (d = a.config.args) ? void 0 : d.video_id))) return } Qw(a) } else a.Ia = dl(function () { Lw(a) }, 50) } }
    function Qw(a) { Bw(a); a.da = !0; var b = Jw(a); if (b) { a.o = Rw(a, b, "addEventListener"); a.W = Rw(a, b, "removeEventListener"); var c = b.getApiInterface(); c = c.concat(b.getInternalApiInterface()); for (var d = a.api, e = 0; e < c.length; e++) { var f = c[e]; d[f] || (d[f] = Rw(a, b, f)) } } for (var g in a.i) a.i.hasOwnProperty(g) && a.o && a.o(g, a.i[g]); Fw(a); a.X && a.X(a.api); a.K.ta("onReady", a.api) }
    function Rw(a, b, c) { var d = b[c]; return function () { var e = Ja.apply(0, arguments); try { return a.lastError = null, d.apply(b, e) } catch (f) { "sendAbandonmentPing" !== c && (f.params = c, a.lastError = f, Ir(f)) } } }
    function Bw(a) {
        a.da = !1; if (a.W) for (var b in a.i) a.i.hasOwnProperty(b) && a.W(b, a.i[b]); for (var c in a.I) a.I.hasOwnProperty(c) && window.clearTimeout(Number(c)); a.I = {}; a.o = null; a.W = null; b = a.api; for (var d in b) b.hasOwnProperty(d) && (b[d] = null); b.addEventListener = function (e, f) { a.addEventListener(e, f) };
    ...
    function Cw(a) {
        a.addEventListener("WATCH_LATER_VIDEO_ADDED", function (b) { kq("WATCH_LATER_VIDEO_ADDED", b) });
        a.addEventListener("WATCH_LATER_VIDEO_REMOVED", function (b) { kq("WATCH_LATER_VIDEO_REMOVED", b) })
    }
    l.addEventListener = function (a, b) { var c = this, d = Hw(this, b); d && (0 <= eb(this.Xa, a) || this.i[a] || (b = Sw(this, a), this.o && this.o(a, b)), this.K.subscribe(a, d), "onReady" === a && this.isReady() && dl(function () { d(c.api) }, 0)) };
    l.removeEventListener = function (a, b) { this.h() || (b = Hw(this, b)) && ti(this.K, a, b) };
    function Hw(a, b) {
        var c = b; if ("string" === typeof b) {
            if (a.ka[b]) return a.ka[b]; c = function () { var d = Ja.apply(0, arguments), e = B(b); if (e) try { e.apply(z, d) } catch (f) { Hr(f) } };
            a.ka[b] = c
        } return c ? c : null
    }
    function Sw(a, b) {
        var c = "ytPlayer" + b + a.s; a.i[b] = c; z[c] = function (d) {
            var e = dl(function () { if (!a.h()) { try { a.K.ta(b, null != d ? d : void 0) } catch (h) { Ir(new P("PlayerProxy error when creating global callback", { error: h, event: b, playerId: a.s, data: d })) } var f = a.I, g = String(e); g in f && delete f[g] } }, 0);
            sb(a.I, String(e))
        };
        return c
    }
    l.getPlayerType = function () { return this.P || (Jw(this) ? "html5" : null) };
    l.getLastError = function () { return this.lastError };
    function Mw(a) { a.cancel(); Bw(a); a.P = null; a.config && (a.config.loaded = !1); var b = Jw(a); b && (Iw(a) || !Pw(a) ? a.l = b : (b && b.destroy && b.destroy(), a.l = null)); if (a.m) for (a = a.m; b = a.firstChild;)a.removeChild(b) }
    l.cancel = function () { this.F && yv(Kw(this), this.F); window.clearTimeout(this.Ia); this.O = !1 };
    l.C = function () { Mw(this); if (this.l && this.config && this.l.destroy) try { this.l.destroy() } catch (b) { Hr(b) } this.ka = null; for (var a in this.i) this.i.hasOwnProperty(a) && (z[this.i[a]] = null); this.va = this.config = this.api = null; delete this.m; delete this.j; J.prototype.C.call(this) };
    function Pw(a) { var b, c; a = null == (b = a.config) ? void 0 : null == (c = b.args) ? void 0 : c.fflags; return !!a && -1 !== a.indexOf("player_destroy_old_version=true") }
    function Kw(a) { return a.webPlayerContextConfig ? a.webPlayerContextConfig.jsUrl : (a = a.config.assets) ? a.js : "" }
    function Ow(a) { return a.webPlayerContextConfig ? a.webPlayerContextConfig.cssUrl : (a = a.config.assets) ? a.css : "" }
    function Nw(a, b) { if (a.webPlayerContextConfig) var c = a.webPlayerContextConfig.serializedExperimentFlags; else { var d; if (null == (d = a.config) ? 0 : d.args) c = a.config.args.fflags } return "true" === Rk(c || "", "&")[b] }
    function Gw(a) { for (var b = {}, c = p(Object.keys(a)), d = c.next(); !d.done; d = c.next()) { d = d.value; var e = a[d]; b[d] = "object" === typeof e ? vb(e) : e } return b }
    ; var Tw = {}, Uw = "player_uid_" + (1E9 * Math.random() >>> 0); function Vw(a, b) {
        var c = "player", d = !1; d = void 0 === d ? !0 : d; c = "string" === typeof c ? kf(c) : c; var e = Uw + "_" + Ra(c), f = Tw[e]; if (f && d) return Ww(a, b) ? f.api.loadVideoByPlayerVars(a.args || null) : f.loadNewVideoConfig(a), f.api; f = new Aw(c, e, a, b, void 0); Tw[e] = f; kq("player-added", f.api); te(f, function () { delete Tw[f.getId()] });
        return f.api
    }
    function Ww(a, b) { return b && b.serializedExperimentFlags ? b.serializedExperimentFlags.includes("web_player_remove_playerproxy=true") : a && a.args && a.args.fflags ? a.args.fflags.includes("web_player_remove_playerproxy=true") : !1 }
    ; var Xw = null, Yw = null, Zw = null; function $w() { ax() }
    function bx() { ax() }
    function ax() { var a = Xw.getVideoData(1); a = a.title ? a.title + " - YouTube" : "YouTube"; document.title !== a && (document.title = a) }
    function cx() { Xw && Xw.sendAbandonmentPing && Xw.sendAbandonmentPing(); L("PL_ATT") && Kv.dispose(); for (var a = Xh, b = 0, c = zv.length; b < c; b++)a.fa(zv[b]); zv.length = 0; xv("//static.doubleclick.net/instream/ad_status.js"); Av = !1; Bk("DCLKSTAT", 0); re(Zw, Yw); Xw && (Xw.removeEventListener("onVideoDataChange", $w), Xw.destroy()) }
    ; function dx(a, b, c) { a = "ST-" + kc(a).toString(36); b = b ? tc(b) : ""; c = c || 5; ps() && tl(a, b, c) }
    ; function ex(a, b, c) {
        b = void 0 === b ? {} : b; c = void 0 === c ? !1 : c; var d = L("EVENT_ID"); d && (b.ei || (b.ei = d)); if (b) {
            d = a; var e = void 0 === e ? !0 : e; var f = L("VALID_SESSION_TEMPDATA_DOMAINS", []), g = oc(window.location.href); g && f.push(g); g = oc(d); if (0 <= eb(f, g) || !g && 0 == d.lastIndexOf("/", 0)) if (M("autoescape_tempdata_url") && (f = document.createElement("a"), fc(f, d), d = f.href), d && (d = pc(d), f = d.indexOf("#"), d = 0 > f ? d : d.slice(0, f))) if (e && !b.csn && (b.itct || b.ved) && (b = Object.assign({ csn: $r() }, b)), h) {
                var h = parseInt(h, 10); isFinite(h) && 0 < h &&
                    dx(d, b, h)
            } else dx(d, b)
        } if (c) return !1; if ((window.ytspf || {}).enabled) spf.navigate(a); else {
            var k = void 0 === k ? {} : k; var m = void 0 === m ? "" : m; var q = void 0 === q ? window : q; c = q.location; a = vc(a, k) + m; var r = void 0 === r ? Ph : r; a: { r = void 0 === r ? Ph : r; for (k = 0; k < r.length; ++k)if (m = r[k], m instanceof Nh && m.bd(a)) { r = new Ob(a, Pb); break a } r = void 0 } r = r || Sb; if (r instanceof Ob) var w = Qb(r); else {
                b: if (Fh) { try { w = new URL(r) } catch (t) { w = "https:"; break b } w = w.protocol } else c: {
    ...
    A("writeEmbed", function () {
        var a = L("PLAYER_CONFIG"); if (!a) { var b = L("PLAYER_VARS"); b && (a = { args: b }) } zs(!0); "gvn" === a.args.ps && (document.body.style.backgroundColor = "transparent"); a.attrs || (a.attrs = { width: "100%", height: "100%", id: "video-player" }); var c = document.referrer; b = L("POST_MESSAGE_ORIGIN"); window !== window.top && c && c !== document.URL && (a.args.loaderUrl = c); au(); c = L("WEB_PLAYER_CONTEXT_CONFIGS").WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER; if (!c.serializedForcedExperimentIds) {
            var d = Wk(window.location.href);
            d.forced_experiments && (c.serializedForcedExperimentIds = d.forced_experiments)
        } Xw = Vw(a, c); Xw.addEventListener("onVideoDataChange", $w); Xw.addEventListener("onReady", bx); a = L("POST_MESSAGE_ID", "player"); L("ENABLE_JS_API") ? Zw = new kw(Xw) : L("ENABLE_POST_API") && "string" === typeof a && "string" === typeof b && (Yw = new rw(window.parent, a, b), Zw = new ow(Xw, Yw.connection)); Bv(); M("ytidb_create_logger_embed_killswitch") || M("embeds_web_disable_nwl") || $l(); a = {}; Wv || (Wv = new Vv); Wv.install((a.flush_logs = { callback: function () { Lq() } },
            a));
        M("embeds_web_disable_nwl") || ap(); M("ytidb_clear_embedded_player") && Xh.U(function () {
            var e; if (!Ju) {
                var f = Us(), g = { Fb: Iu, xc: Hu }; f.h.set(g.Fb, g); g = { Ub: { feedbackEndpoint: Vs(Du), modifyChannelNotificationPreferenceEndpoint: Vs(Eu), playlistEditEndpoint: Vs(Fu), subscribeEndpoint: Vs(Bu), unsubscribeEndpoint: Vs(Cu), webPlayerShareEntityServiceEndpoint: Vs(Gu) } }; var h = Is.getInstance(), k = {}; h && (k.client_location = h); if (void 0 === m) { As.h || (As.h = new As); var m = As.h } void 0 === e && (e = f.resolve(Iu)); ou(g, e, m, k); m = { Fb: uu, yc: nu.h };
                f.h.set(m.Fb, m); Ju = f.resolve(uu)
            } lv()
        })
    });
    var fx = Jk(function (a) {
        if (!a.persisted) {
            hu(); a = xl.getInstance(); var b = Al(119), c = 1 < window.devicePixelRatio; if (document.body && gi(document.body, "exp-invert-logo")) if (c && !gi(document.body, "inverted-hdpi")) { var d = document.body; if (d.classList) d.classList.add("inverted-hdpi"); else if (!gi(d, "inverted-hdpi")) { var e = ei(d); fi(d, e + (0 < e.length ? " inverted-hdpi" : "inverted-hdpi")) } } else !c && gi(document.body, "inverted-hdpi") && hi(); if (b != c) {
                b = "f" + (Math.floor(119 / 31) + 1); d = Bl(b) || 0; d = c ? d | 67108864 : d & -67108865; 0 == d ? delete wl[b] :
                    (c = d.toString(16), wl[b] = c.toString()); c = !0; M("web_secure_pref_cookie_killswitch") && (c = !1); b = a.h; d = []; for (var f in wl) d.push(f + "=" + encodeURIComponent(String(wl[f]))); tl(b, d.join("&"), 63072E3, a.i, c)
            } Vu.h || (Vu.h = new Vu); f = Vu.h; a = 16623; var g = void 0 === g ? {} : g; Object.values(fs).includes(a) || (Ir(new P("createClientScreen() called with a non-page VE", a)), a = 83769); g.isHistoryNavigation || f.h.push({ rootVe: a, key: g.key || "" }); f.o = []; f.M = []; g.Xb ? Yu(f, a, g) : Zu(f, a, g)
        }
    }), gx = Jk(function (a) {
        M("embeds_web_enable_dispose_player_if_page_not_cached_killswitch") ?
        cx() : a.persisted || cx()
    }), hx = Jk(cx);
    window.addEventListener ? (window.addEventListener("load", fx), window.addEventListener("pageshow", fx), window.addEventListener("pagehide", gx)) : window.attachEvent && (window.attachEvent("onload", fx), window.attachEvent("onunload", hx)); A("yt.abuse.player.botguardInitialized", B("yt.abuse.player.botguardInitialized") || Lv); A("yt.abuse.player.invokeBotguard", B("yt.abuse.player.invokeBotguard") || Mv); A("yt.abuse.dclkstatus.checkDclkStatus", B("yt.abuse.dclkstatus.checkDclkStatus") || Cv);
    A("yt.player.exports.navigate", B("yt.player.exports.navigate") || ex); A("yt.util.activity.init", B("yt.util.activity.init") || $p); A("yt.util.activity.getTimeSinceActive", B("yt.util.activity.getTimeSinceActive") || cq); A("yt.util.activity.setTimestamp", B("yt.util.activity.setTimestamp") || aq);
}).call(this);
